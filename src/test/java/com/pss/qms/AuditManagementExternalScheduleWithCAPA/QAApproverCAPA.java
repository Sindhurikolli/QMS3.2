...
public class QAApproverCAPA extends AMLoginDetails {
	 
	 @Test
	    public void methodtodoQAApproverCAPA() throws InterruptedException, IOException, DocumentException, Exception {
//			try {
		  	...
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAApproverCAPA", "PSS-QMS-010",
						"Pass");
