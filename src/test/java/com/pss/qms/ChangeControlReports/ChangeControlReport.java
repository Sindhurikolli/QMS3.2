 ...
 * @author likhitha
 */
public class ChangeControlReport extends CCLoginDetails {
...
//        String chgControlNumber = chgCtrlNoWithPlantCode + sdf + chgCtrlId;
        ...
        if (isRecordSelected) {
            ...
            WebElement element = driver.findElement(By.id("viewBtnInCcReportsPostClosure"));
...
//            Thread.sleep(1000);
              String applicationWindowOrPDF = driver.getWindowHandle();
                ...
                Thread.sleep(3000);
                driver.findElement(By.id("viewBtnInCcReportsPostClosure")).click();
                Thread.sleep(12000);
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String CCNumberSequence = driver.findElement(By.xpath("//*[@id=\"ccReportsPostClosureResultsTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();
                        Thread.sleep(5000);
                    ...
                    String CCNumberSequence = driver.findElement(By.xpath("//*[@id=\"ccReportsPostClosureResultsTable\"]/div/table/tbody/tr/td[3]")).getText();
                    if (chgCtrlId.equalsIgnoreCase(CCNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"ccReportsPostClosureResultsTable\"]/div/table/tbody/tr/td[3]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
