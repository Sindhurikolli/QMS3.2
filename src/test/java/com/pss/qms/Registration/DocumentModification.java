 ...
 * @author likhitha
 */
public class DocumentModification extends RegistrationLoginDetails {
    
   @Test
    public void DocModification() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@id=\"registration_tile_Id\"]/div/div/div/h2")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAddMenusListId\"]/ul/li[4]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.id("modifySelectionInDocument")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"existingDocumentDetails\"]/div/div[4]/table/tbody/tr[1]/td[3]")).click();
        Thread.sleep(10000);
       driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
        Thread.sleep(10000);
       
        driver.findElement(By.id("docNumInRegDocumentAdd")).clear();
        Thread.sleep(4000);
        driver.findElement(By.id("docNumInRegDocumentAdd")).sendKeys(properties.getProperty("DOC_NO"));
        Thread.sleep(4000);

//        driver.findElement(By.id("prodDescriptionInRegisterProdInQms")).sendKeys(properties.getProperty("PRODUCT_DESC"));
//        Thread.sleep(4000);
        driver.findElement(By.id("selAppBtnInRegDocAdd")).click();
        Thread.sleep(4000);
...
//        Thread.sleep(4000);
        driver.findElement(By.id("submitBtnInRegDocumentAdd")).click();
        Thread.sleep(5000);
