 ...
 * @author likhitha
 */
public class RiskAssessmentRejectMC extends MCLoginDetails {

	@Test
	public void RiskAssessmentRejectMC() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RiskAssessmentRejectMC"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("RiskAssessmentRejectMC", "PSS-QMS-030", "Pass");
