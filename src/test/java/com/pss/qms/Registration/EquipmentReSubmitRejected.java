 ...
 * @author likhitha
 */
public class EquipmentReSubmitRejected extends RegistrationLoginDetails {
    
    @Test
    public void EquipmentReSubmitRejected() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(10000);
        driver.findElement(By.cssSelector("#rejectSelectionInEquipment")).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"rejectedEquipmentsGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(8000);
