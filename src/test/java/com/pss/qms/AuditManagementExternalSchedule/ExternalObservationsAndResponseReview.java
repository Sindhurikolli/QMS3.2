...
public class ExternalObservationsAndResponseReview extends AMLoginDetails {
	...
	@Test
	public void toExternalObservationsAndResponseReview() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("External ObservationsAndResponse Review",
					"PSS-QMS-005", "Pass");
...
//	}
	...
	private void methodToDoExternalAuditReview() throws Exception {
		...
		String AuditId = properties.getProperty("EXTERNAL_AUDIT_PLAN_NAME");
