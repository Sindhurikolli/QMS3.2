...
public class PostApprovalActionReviewRevert extends DeviationLoginDetails {
	 
	
		@Test
	    public void toPostApprovalActionReviewRevert()  throws InterruptedException, IOException, DocumentException, Exception {
//			try {
...
//	            driver.findElement(By.cssSelector("body > div:nth-child(43) > div.ui-dialog-titlebar.ui-widget-header.ui-corner-all.ui-helper-clearfix.ui-draggable-handle > button > span.ui-button-icon-primary.ui-icon.ui-icon-closethick")).click();
	           ...
	           sno++;
	           JavascriptExecutor jse = (JavascriptExecutor) driver;
	           WebElement element = driver.findElement(By.id("rejectBtnInApprovedActionsForm"));
	            jse.executeScript("arguments[0].scrollIntoView(true);", element);
