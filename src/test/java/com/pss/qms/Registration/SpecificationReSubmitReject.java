 ...
 * @author likhitha
 */
public class SpecificationReSubmitReject extends RegistrationLoginDetails {
    
    @Test
    public void SpecificationReSumitReject() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(8000);
        driver.findElement(By.id("rejectSelectionInSpecification")).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"rejectedSpecificationGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(8000);
