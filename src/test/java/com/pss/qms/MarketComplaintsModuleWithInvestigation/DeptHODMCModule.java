...
public class DeptHODMCModule extends MCLoginDetails {
    @Test
    public void DeptHODMC() throws InterruptedException {
        Thread.sleep(2000);
    ...
    private void methodToDoDeptHODMC() throws InterruptedException {
        int count = 0;
...
//        String DepartmentCode = properties.getProperty("CHG_CONTROL_NO");
        ...
        isRecordSelected = selectRecdDeptHODMC(MCNumber, isRecordSelected, count);
        Thread.sleep(8000);
        if (isRecordSelected) {
            Thread.sleep(3000);
...
//            Thread.sleep(3000);
            ...
            WebElement element = driver.findElement(By.id("approveMcQaHodReview"));
    ...
    private boolean selectRecdDeptHODMC(String MCNumber, boolean isRecordSelected, int count) throws InterruptedException {
