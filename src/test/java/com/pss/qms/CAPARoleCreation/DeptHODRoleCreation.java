...
public class DeptHODRoleCreation extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptHODRoleCreation"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptHODRoleCreation", "PSS-QMS-055",
					"Pass");
...
//    }
    ...
    private void createRoleMethod() throws Exception {
    	sno++;
        Thread.sleep(1000);
        driver.findElement(By.id("roleNameInCreateRoleInCapa")).sendKeys(properties.getProperty("Role_Name2"));
