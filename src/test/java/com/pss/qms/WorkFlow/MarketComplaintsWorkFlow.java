...
public class MarketComplaintsWorkFlow extends QMSLoginDetails {

    @Test
    public void MarketComplaintsWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
		...
		Thread.sleep(5000);
		driver.findElement(By.cssSelector("#cmGeneralBodySection > a[onclick='redirectToMcWorkFlowTab(mcWorkFlowSetActiveItemId)']")).click();
        Thread.sleep(2000);
        toMarketComplaintsWorkFlowMethod();
        
            }

    private void toMarketComplaintsWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
        ...
        String DhodE_Codes = properties.getProperty("MCQAApproverE_Codes");
        ...
        Thread.sleep(3000);
      driver.findElement(By.id("skipthisStageId_3")).click();
      Thread.sleep(1000);
      driver.findElement(By.xpath("//*[@id=\"modal-window\"]/div/div/div[3]/a[2]")).click();
      Thread.sleep(1000);
      jse.executeScript("window.scrollBy(0,500)");
      Thread.sleep(1000);
      driver.findElement(By.id("skipthisStageId_4")).click();
      Thread.sleep(1000);
      driver.findElement(By.xpath("//*[@id=\"modal-window\"]/div/div/div[3]/a[2]")).click();
      Thread.sleep(1000);
