...
//        Thread.sleep(10000);
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAppMenusListId\"]/ul/li[1]/a")).click();
        Thread.sleep(10000);
...
//        String chgCtrlId = "-0013";
        ...
        Thread.sleep(10000);
        if (isRecordSelected) {
            driver.findElement(By.id("commentsInViewQmsProdoctApp")).sendKeys(properties.getProperty("PROD_COMMENTS"));
            Thread.sleep(4000);
            driver.findElement(By.id("rejectBtnRegProd")).click();
            Thread.sleep(3000);
    ...
    private boolean selectRecdMCReports(String chgControlNumber, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber)))) {
                chgControlNumber = driver.findElement(By.xpath(".//*[@id=\"qmsProductApprovalGrid\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber))) {
                chgControlNumber = driver.findElement(By.xpath("//*[@id=\"qmsProductApprovalGrid\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"qmsProductApprovalGrid\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();//documentTypeName
                        if (chgControlNumber.equalsIgnoreCase(capaNumberSequence)) {
                            driver.findElement(By.xpath("//*[@id=\"qmsProductApprovalGrid\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).click();
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"qmsProductApprovalGrid\"]/div/table/tbody/tr/td[2]")).getText();
                    if (chgControlNumber.equalsIgnoreCase(capaNumberSequence)) {
