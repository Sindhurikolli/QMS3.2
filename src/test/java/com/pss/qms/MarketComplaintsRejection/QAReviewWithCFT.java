...
public class QAReviewWithCFT extends MCLoginDetails {
...
//        String DepartmentCode = properties.getProperty("DEPARTMENT_CODE_QMS");
        ...
        if (isRecordSelected) {
            ...
            Thread.sleep(1000);
            driver.findElement(By.xpath(".//*[@id='cftTeamTableWindowContainer']/div/table/tbody/tr/td[2]")).click();
            Thread.sleep(1000);
