...
//					false);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='mcActionItemReject.do']")));
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#actItmRejectTable > div > div.jtable-busy-message[style='display: none;']")));
...
//			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "upload the document", sno, false);
			...
			ApproveFromDropDown.selectByIndex(2);
