 ...
 * @author Mounika
 */
public class ReAssignCAPA extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ReAssignCAPA"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ReAssignCAPA", "PSS-QMS-075",
					"Pass");
        ...
        Thread.sleep(4000);
        sno++;
        driver.findElement(By.cssSelector("#side-menu > li:nth-child(4) > a")).click();
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on ReAssign menu",sno,false);
        Thread.sleep(4000);
        sno++;
        driver.findElement(By.id("deptSelBtn_CaOrPaReAssignAuditPage")).click();
        ...
        Thread.sleep(4000);
        sno++;
        driver.findElement(By.id("searchBtn_CaOrPaReAssignAuditPage")).click();
