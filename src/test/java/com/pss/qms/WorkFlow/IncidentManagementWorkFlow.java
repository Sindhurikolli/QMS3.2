...
public class IncidentManagementWorkFlow extends QMSLoginDetails {

    @Test
    public void IncidentManagementWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("IncidentManagementModule"));
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"loginform\"]/div[7]/button[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("workFlowInInc")).click();
        Thread.sleep(2000);
        toIncidentManagementWorkFlowMethod();
        
            }

    private void toIncidentManagementWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
        ...
        String DhodE_Codes = properties.getProperty("INCDepartmentHodE_Codes");
        ...
        Thread.sleep(3000);
        driver.findElement(By.id("locTreeInQmsWfReg_1_a")).click();
        ...
        Thread.sleep(3000);
        String QMSCoordinatorE_Codes = properties.getProperty("INCQMSCoordinatorE_Codes");
        ...
        jse.executeScript("window.scrollBy(0,250)");
        Thread.sleep(3000);
        String SrManagementE_Codes = properties.getProperty("INCSrManagementE_Codes");
        String SrManagementECodes [] =SrManagementE_Codes.split(",");
        for(int i=0; i<SrManagementECodes.length; i++)
        {
        driver.findElement(By.id("workFlowUserBrowse3Button")).click();
        Thread.sleep(3000);
        driver.findElement(By.linkText(properties.getProperty("WFLocation"))).click();
        Thread.sleep(1000);
        String srManagementEcode = SrManagementECodes[i].trim();
        boolean isrecordSelectedForUser = false;
        int count3 = 0;
        isrecordSelectedForUser = selectingTheUser(srManagementEcode, isrecordSelectedForUser, count3);
        Thread.sleep(1000);
        if(isrecordSelectedForUser)
        {
        driver.findElement(By.id("selectBrowse1Button")).click();
        ...
        {
        	driver.findElement(By.id("cancelBrowse1Button")).click();
        	System.out.println("E-Code -"+srManagementEcode+"Not Selected");
        }
        }
        
        Thread.sleep(3000);
        String QAHODE_Codes = properties.getProperty("INCQAHODE_Codes");
        ...
        Thread.sleep(3000);
        String QualityHeadE_Codes = properties.getProperty("INCQualityHeadE_Codes");
