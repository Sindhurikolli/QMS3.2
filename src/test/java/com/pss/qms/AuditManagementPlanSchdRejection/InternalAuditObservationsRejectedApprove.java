...
public class InternalAuditObservationsRejectedApprove extends AMLoginDetails {

	@Test
	public void toInternalAuditObservationsRejectedApprove() throws Exception {
...
//	}
	...
	private void methodToDoAuditObsRejectApprove() throws Exception {
		...
		String AuditId = properties.getProperty("PLAN_NAME_PLAN_SCHEDULE_IN_REJECT_FLOW");
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((AuditId == null) || ("".equalsIgnoreCase(AuditId)))) {
				AuditId = driver.findElement(By.xpath(
						"//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr[1]/td[3]"))
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String PlanNumberSequence = driver.findElement(By
								.xpath(".//*[@id='rejectAuditsContainerInEnterAuditFindingsForm']/div/table/tbody/tr[ "
										+ i + "]/td[3]"))
								.getText();// documentTypeName
						if (AuditId.equalsIgnoreCase(PlanNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr[ "
											+ i + " ]/td[3]"))
									.click();
