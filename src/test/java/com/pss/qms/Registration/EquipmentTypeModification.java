 ...
 * @author likhitha
 */
public class EquipmentTypeModification extends RegistrationLoginDetails {
    ...
    public void EquipmentTypeRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("modifySelectionInEqptType")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"existingEquipmentTypeRegister\"]/div/div[4]/table/tbody/tr[1]/td[3]")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.id("equpTypeReg")).clear();
        Thread.sleep(3000);
