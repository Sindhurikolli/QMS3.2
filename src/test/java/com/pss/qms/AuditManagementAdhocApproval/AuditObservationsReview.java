...
public class AuditObservationsReview extends AMLoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AuditObservationsReview"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditObservations Review", "PSS-QMS-005", "Pass");
...
//	}
	...
	private boolean selectRecdReviewAuditObs(String AMId, boolean isRecordSelected, int count)
