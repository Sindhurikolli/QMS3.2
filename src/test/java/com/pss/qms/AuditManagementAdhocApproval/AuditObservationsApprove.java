...
public class AuditObservationsApprove extends AMLoginDetails {
	@Test
	public void toAuditObservationApprove() throws Exception {
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("PlannedScheduleAM", "PSS-QMS-006", "Pass");
...
//       document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Approvals Menu",sno,false);
			Thread.sleep(5000);
			sno++;
			driver.findElement(By.id("auditObservationsAppMenuInAM")).click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Audit Observations Menu", sno,
					false);
			Thread.sleep(5000);
			WebDriverWait wait1 = new WebDriverWait(driver, 60);
			wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#auditsContainerInEnterAuditFindingsForm > div > div.jtable-busy-message[style='display: none;']")));
...
//	}
	...
	private boolean selectRecdAuditObservationApprove(String AMId, boolean isRecordSelected, int count)
