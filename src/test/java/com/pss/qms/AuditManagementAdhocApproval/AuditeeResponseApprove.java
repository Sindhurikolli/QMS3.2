...
public class AuditeeResponseApprove extends AMLoginDetails {
	...
	@Test
	public void toAuditeeResponseApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponse Approve", "PSS-QMS-009", "Pass");
...
//		         Thread.sleep(2000);
			...
			driver.findElement(By.id("commentsInAmReviewAuditFindingAppForm"))
					.sendKeys(properties.getProperty("AM_100"));
