...
public class DeptHODRoleBaseAccess extends CCLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Roles.selectByVisibleText(properties.getProperty("Role_Name2"));
         Thread.sleep(3000);
         ...
         Thread.sleep(5000);
         driver.findElement(By.id("ccPostAppActionsReviewMenu")).click();
         Thread.sleep(3000);
