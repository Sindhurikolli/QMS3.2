...
public class ClosureRegister extends MCLoginDetails {

	@Test
	public void ClosureRegister() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("MCCompletion", "PSS-QMS-007", "Pass");
