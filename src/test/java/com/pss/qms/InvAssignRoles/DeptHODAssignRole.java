package com.pss.qms.InvAssignRoles;
...
public class DeptHODAssignRole extends InvestigationLoginDetails {
...
//       String InvFirstName =properties.getProperty("First_Name1");
       String UserFirsrtName =properties.getProperty("FIRST_NAME5");
...
//       Thread.sleep(3000);
       ...
       Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"bootstrap-duallistbox-nonselected-list_\"]/option[6]")).click();
         Thread.sleep(3000);
        ...
        Thread.sleep(1000);
        driver.findElement(By.className("//*[@id=\"modal-window\"]/div/div/div[3]/a")).click();
        Thread.sleep(1000);
    }
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (perPageNoOfRecordsPresent > 1) {
                    ...
                    String InvReviewFullName = driver.findElement(By.xpath("//*[@id=\"singleSelUsersTableContainer\"]/div/table/tbody/tr[1]/td[1]")).getText();
                ...
                if ((!isRecordSelectedForUser) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#singleSelUsersTableContainer > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-last")).click();//next page in Document approve list
                    Thread.sleep(5000);
