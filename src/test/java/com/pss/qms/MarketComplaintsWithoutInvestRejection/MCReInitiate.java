...
public class MCReInitiate extends MCLoginDetails {
	...
	public void MCReInitiate() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("MCReInitiate", "PSS-QMS-003", "Pass");
...
//					false);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='mcMyActRejectPage.do']")));
...
//    Thread.sleep(20000);
		wait1.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#mcRejectTable > div > div.jtable-busy-message[style='display: none;']")));
...
//            driver.findElement(By.id("addBtnInActionItemAddDlg")).click();
	...
	private boolean selectRecdReInitiate(String MarketComplaintsId, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			WebElement element = driver.findElement(By.xpath("//*[@id=\"mcRejectTable\"]/div/div[4]/div[2]/span"));
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					...
					WebElement element = driver
							.findElement(By.xpath("//*[@id=\"mcRejectTable\"]/div/table/tbody/tr/td[3]"));
					JavascriptExecutor js = (JavascriptExecutor) driver;
					js.executeScript("arguments[0].click();", element);
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#mcRejectTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-last.jtable-page-number-disabled"))
