...
public class CAPAPerformTaskCA extends CAorPALoginDetails {
	...
	@Test
	public void CAPAPerformTaskCA() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CAPAPerformTaskCA" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CAPAPerformTaskCA", "PSS-QMS-005", "Pass");
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href='caPerformTaskPage.do']")));
...
//            sno++;//*[@id="actItmPerformTable"]/div/table/tbody/tr[8]/td[5]
//            Thread.sleep(3000); 
...
//             js4.executeScript("arguments[0].click();", element4);
			...
			WebElement element9 = driver.findElement(
					By.xpath("//*[@id=\"supportingDocsJtableInCaPerform\"]/div/div[3]/div[2]/span/span[1]"));
			...
			waitsupp.until(ExpectedConditions.invisibilityOf(driver
					.findElement(By.cssSelector("#supportingDocsJtableInCaPerform > div > div.jtable-busy-message"))));
			Thread.sleep(4000);
			driver.findElement(By.xpath("//*[@id=\"supportingDocsJtableInCaPerform\"]/div/div[3]/div[2]/span/span[1]"))
					.click();
			...
			//waitload.until(ExpectedConditions.presenceOfElementLocated(By.id("id=locTreeInQmsProdReg_2_switch")));
...
//            Thread.sleep(5000);
	...
	private boolean selectRecdCAPerformTaskCAPA(String CAPANumber, boolean isRecordSelected, int count)
		...
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			Helper.scrollElement(driver, By.xpath("//*[@id=\"actItmPerformTable\"]/div/div[4]/div[2]/span"));
			String a = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/div[4]/div[2]/span")).getText();																													
