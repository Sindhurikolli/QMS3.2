 ...
 * @author likhitha
 */
public class ProductResubmitRejected extends RegistrationLoginDetails {
    ...
    public void ProductRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("rejectSelectionInProduct")).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"rejectedProductGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(8000);
