...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItem Perform", "PSS-QMS-007", "Pass");
...
//	}
	...
	private void methodToDoAuditeeResponseApprove() throws Exception {
		...
		String AMId = properties.getProperty("External_AUDIT_NAME_WITH_AINO");
