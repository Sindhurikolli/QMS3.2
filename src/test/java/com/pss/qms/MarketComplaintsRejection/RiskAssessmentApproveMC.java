 ...
 * @author likhitha
 */
public class RiskAssessmentApproveMC extends MCLoginDetails {

	@Test
	public void RiskAssessmentApproveMC() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RiskAssessmentApproveMC"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("RiskAssessmentApproveMC", "PSS-QMS-032", "Pass");
