...
public class SRManagementRole extends DeviationLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
        driver.findElement(By.id("roleNameInCreateRoleInDev")).sendKeys(properties.getProperty("Role_Name5"));
        Thread.sleep(3000);
