...
//            Thread.sleep(3000);
        sno++;
            ...
            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Regulatory CheckBox",sno,false);
            Thread.sleep(3000);
            ...
            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select The Location",sno,false);
            Thread.sleep(3000);
//            driver.findElement(By.id("locTreeForRegulatoryTeamInQmsDevReview_3_ico")).click();
//            Thread.sleep(3000);
            //To Select Reg User
