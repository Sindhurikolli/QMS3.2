package com.pss.qms.RiskAssessmentReports;
...
public class RiskAssessmentReport extends RALoginDetails {
	...
	@Test
	public void RAReport() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			document = new Document();
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RiskAssessmentReport"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("RiskAssessmentReport", "PSS-QMS-001", "Pass");
			writer.setPageEvent(event);
			document.open();
			driver.findElement(By.name("loginUserName")).sendKeys(properties.getProperty("CAPA_APP"));
			Thread.sleep(1000);
...
//			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Risk Assessment Module", sno,
//					false);
			sno++;
			Thread.sleep(3000);
			driver.findElement(By.cssSelector("#reportsInRA > h2")).click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Reports Tab", sno, false);
//	        sno++;
//	        driver.findElement(By.id("fromDateInRaReportsPostClosure")).sendKeys(properties.getProperty("START_DATE"));
...
//	        Thread.sleep(3000);
//	        driver.findElement(By.id("toDateInRaReportsPostClosure")).sendKeys(todaysDate);
//	        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter To Date",sno,false);
			...
			methodToDoRiskAssessmentReport();
			Thread.sleep(3000);
			document.close();
			writer.close();
...
//		}
	...
	private void methodToDoRiskAssessmentReport() throws Exception {
		
		int count = 0;
		boolean isRecordSelected = false;
		String RASequence = properties.getProperty("RA_NUMBER");
		isRecordSelected = selectRecdRiskAssessmentReport(RASequence, isRecordSelected, count);
		Thread.sleep(3000);
		if (isRecordSelected) {
			JavascriptExecutor jse = (JavascriptExecutor) driver;
			WebElement element = driver.findElement(By.id("viewBtnInRaReportsPostClosure"));
...
//	            Thread.sleep(3000);
	...
	private boolean selectRecdRiskAssessmentReport(String RASequence, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By.xpath("//*[@id=\"raReportsPostClosureResultsTable\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((RASequence == null) || ("".equalsIgnoreCase(RASequence)))) {
				RASequence = driver
						.findElement(
								By.xpath("//*[@id=\"raReportsPostClosureResultsTable\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((RASequence == null) || ("".equalsIgnoreCase(RASequence))) {
				RASequence = driver
						.findElement(By.xpath("//*[@id=\"raReportsPostClosureResultsTable\"]/div/table/tbody/tr/td[3]"))
						.getText();// documentType
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String RANumberSequence = driver.findElement(By.xpath(
								"//*[@id=\"raReportsPostClosureResultsTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
								.getText();// documentTypeName
						if (RASequence.equalsIgnoreCase(RANumberSequence)) {
							driver.findElement(
									By.xpath("//*[@id=\"raReportsPostClosureResultsTable\"]/div/table/tbody/tr[ " + i
											+ " ]/td[3]"))
									.click();
					...
					String RANumberSequence = driver
							.findElement(
									By.xpath("//*[@id=\"raReportsPostClosureResultsTable\"]/div/table/tbody/tr/td[3]"))
							.getText();
					if (RASequence.equalsIgnoreCase(RANumberSequence)) {
						driver.findElement(
								By.xpath("//*[@id=\"raReportsPostClosureResultsTable\"]/div/table/tbody/tr/td[3]"))
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#raReportsPostClosureResultsTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
