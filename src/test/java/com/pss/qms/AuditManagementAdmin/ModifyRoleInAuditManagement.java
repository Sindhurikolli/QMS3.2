...
public class ModifyRoleInAuditManagement extends AMLoginDetails {
    
	 @Test
	    public void methodtoModifyRole() throws InterruptedException, IOException, DocumentException, Exception {
//			try {

				document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ModifyRoleInAuditManagement"
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("ModifyRoleInAuditManagement", "PSS-QMS-001",
						"Pass");
	     ...
	     im = Image.getInstance(input);
	        ...
	        todoModifyRoleInAuditManagement();
	        document.close();
			writer.close();
...
//		}
	    ...
	    private void todoModifyRoleInAuditManagement() throws Exception {
	    	sno++;
	    	Select Roles = new Select(driver.findElement(By.id("roleInModifyRoleInAM")));
	    	Roles.selectByIndex(9);
	    	document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select The Role",sno,false); 
	    	Thread.sleep(1000);
	    	 driver.findElement(By.id("roleNameInModifyRoleInAM")).clear();
	    	
	        sno++;
	        driver.findElement(By.id("roleNameInModifyRoleInAM")).sendKeys(properties.getProperty("MODIFY_ROLE_NAME_IN_AM"));
...
//	        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Role Name",sno,false); 
	        sno++;
	        driver.findElement(By.id("subBtnIdInModifyRoleInAM")).click();
