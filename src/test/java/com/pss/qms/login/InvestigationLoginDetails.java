...
public class InvestigationLoginDetails {
...
//private static String loginUserPassword = System.getProperty("userpassword");
	...
	public void setUp() throws Exception {
		...
		if (propertiesFilePath != null) {
			...
			propertyFilePathName = "src/test/java/QMSUIProperties/Investigation.properties";
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Investigation.properties not found at " + propertyFilePath);
		}
