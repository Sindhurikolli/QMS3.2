...
//		try {
            ...
            writer.open();
            HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponseReview Reject", "PSS-QMS-001",
					"Pass");
...
//	}
    ...
    private boolean selectRecdAuditeeResponseReject(String AuditId, boolean isRecordSelected, int count) throws InterruptedException {
