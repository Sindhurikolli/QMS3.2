...
public class DeviationWorkFlow extends QMSLoginDetails {

    @Test
    public void DeviationWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("DeviationModule"));
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"loginform\"]/div[7]/button[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("workFlowInDev")).click();
        Thread.sleep(2000);
        toDeviationWorkFlowMethod();
        
            }

    private void toDeviationWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
        ...
        String DhodE_Codes = properties.getProperty("DEVDepartmentHodE_Codes");
        ...
        Thread.sleep(3000);
        String QMSCoordinatorE_Codes = properties.getProperty("DEVQMSCoordinatorE_Codes");
        ...
        jse.executeScript("window.scrollBy(0,250)");
        Thread.sleep(3000);
        String SrManagementE_Codes = properties.getProperty("DEVSrManagementE_Codes");
        ...
        Thread.sleep(3000);
        String QAHODE_Codes = properties.getProperty("DEVQAHODE_Codes");
