...
public class MultiCFTGroupCreationTest{
    ...
    public void toMultiUserCreation(String CFTPlantName, String UserGroupforCFT, String DepartmentforCFT ) throws Throwable {
       
		Thread.sleep(5000);
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\test\\java\\QMSUIProperties\\Registration.properties");
		properties.setProperty("CFTPlantName", CFTPlantName);
		properties.setProperty("UserGroupforCFT", UserGroupforCFT);
		properties.setProperty("DepartmentforCFT", DepartmentforCFT);
        ...
        login.setUp();
        CFTGroup cft = new CFTGroup();
        cft.CFTGroupRegistration(); 
    ...
    public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
        ...
        XSSFSheet sh = wb.getSheet("CFTGroup");
