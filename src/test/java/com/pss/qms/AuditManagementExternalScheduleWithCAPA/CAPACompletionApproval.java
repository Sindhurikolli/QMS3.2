...
public class CAPACompletionApproval extends AMLoginDetails {
	 
	 @Test
	    public void methodtodoCAPACompletionApproval() throws InterruptedException, IOException, DocumentException, Exception {
//			try {
		  	...
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("CAPACompletionApproval", "PSS-QMS-016",
						"Pass");
	     ...
	     im = Image.getInstance(input);
	         ...
	         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on CompleteApproval Menu",sno,false);
	        todoCAPACompletionApproval();
	        document.close();
			writer.close();
...
//		}
	    ...
	    private void todoCAPACompletionApproval() throws Exception {
	         ...
	         if (isRecordSelected) {
	             ...
	             document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Approve RadioButton",sno,false);
	               sno++;
	             driver.findElement(By.id("comments_CapaCmplApprovalPage")).sendKeys(properties.getProperty("Task_Desc_2000"));
		            ...
		            while (noOfRecordsChecked < totalNoOfRecords) {
		                if (totalNoOfRecords > 1) {
		                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
		                        String capaNumberSequence = driver.findElement(By.xpath(".//*[@id='capaRecsTable_CapaCmplApprovalPage']/div/table/tbody/tr[ " + i + "]/td[4]")).getText();//documentTypeName
		                        if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
		                            driver.findElement(By.xpath("//*[@id=\"capaRecsTable_CapaCmplApprovalPage\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).click();
