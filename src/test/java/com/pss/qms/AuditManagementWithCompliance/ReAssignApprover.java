...
public class ReAssignApprover extends AMLoginDetails {
    
   @Test
    public void ReAssignApproverAM() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			document = new Document();
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ReAssignApprover"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ReAssignApprover", "PSS-QMS-001",
					"Pass");
...
//         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);
         sno++;  
         driver.findElement(By.xpath("//*[@id=\"amMyActivitiesListMenuId\"]/div[4]/a")).click();
         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on ReAssign Reviewer Menu",sno,false);
         sno++;  
         driver.findElement(By.id("searchBtnInReAssignReviewerOrApprover")).click();
         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Search Button",sno,false);
        methodToDoReAssignApprover();
        document.close();
		writer.close();
...
//	}
    ...
    private void methodToDoReAssignApprover() throws Exception {
        int count = 0;
        boolean isRecordSelected = false;
         String AMId = properties.getProperty("PLAN_NAME_PLANNED_SCHEDULE");
        isRecordSelected = selectRecdReAssignApprover(AMId, isRecordSelected, count);
        if (isRecordSelected) {
        	 sno++;  
           driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
           document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Next Button",sno,false);
           Thread.sleep(1000);
           driver.findElement(By.xpath("//*[@id=\"existingApproverUsersForAuditors\"]/div/table/tbody/tr/td[1]/input")).click();
           sno++; 
            driver.findElement(By.xpath("//*[@id=\"selectUsersForAuditObservationsApproval\"]/div/div[3]/div[2]/span")).click();
            ...
            String UserFirstName = properties.getProperty("APPROVER_LAST_NAME");
	...
	private boolean selectRecdReAssignApprover(String AMId, boolean isRecordSelected, int count) throws InterruptedException {
