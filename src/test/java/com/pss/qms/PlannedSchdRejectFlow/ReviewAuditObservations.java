...
//	}
    ...
    private void methodToDoReviewAudit() throws Exception {
        int count = 0;
        boolean isRecordSelected = false;
        String AMId = properties.getProperty("PLAN_NAME_PLANNED_SCHEDULE");
        isRecordSelected = selectRecdReviewAudit(AMId, isRecordSelected, count);
        if (isRecordSelected) {
        	sno++;
    ...
    private boolean selectRecdReviewAudit(String AMId, boolean isRecordSelected, int count) throws InterruptedException {
