...
public class InvestigationAssignRole extends QMSLoginDetails {

    @Test
    public void InvestigationAssignRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("InvestigationModule"));
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"loginform\"]/div[7]/button[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("adminInInv")).click();
        Thread.sleep(2000);
        toCreateUsers();
    ...
    private void toCreateUsers() throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("searchEmpCode_InSingleUserSelectDialog")).sendKeys(properties.getProperty("InvestigationUserE_Code"));
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String RoleName = properties.getProperty("InvestigationRoleName");
      ...
      {
    	  Roletoselect.selectByVisibleText(properties.getProperty("InvestigationRoleName"));
    	  Thread.sleep(2000);
