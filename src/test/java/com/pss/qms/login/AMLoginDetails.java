...
//	private static String loginUserPassword = System.getProperty("userpassword");
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src/test/java/QMSUIProperties/AMproperties.properties";	
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("AMproperties.properties not found at " + propertyFilePath);
		}
