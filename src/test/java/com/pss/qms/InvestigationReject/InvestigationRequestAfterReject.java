...
public class InvestigationRequestAfterReject extends InvestigationLoginDetails {

	@Test
	public void InvestigationRequest() throws Exception {
		...
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Investigation Request menu", sno,
				false);
		Thread.sleep(2000);
		driver.findElement(By.id("rejectedInvRequests_InvReqForm")).click();
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document,
				"Click on Reverted Investigation Request menu", sno, false);
		Thread.sleep(2000);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
				"#rejectedInvRequestDetailsJtable > div > div.jtable-busy-message[style='display: none;']")));
	...
	private boolean selectingTheInvReview(String InvLastName, boolean recordSelectedForInv, int count4)
		...
		WebElement table = driver.findElement(By.id("rejectedInvRequestDetailsJtable"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By.xpath("//*[@id=\"rejectedInvRequestDetailsJtable\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count4 == 0) {
			if (((InvLastName == null) || ("".equalsIgnoreCase(InvLastName)))) {
				...
				InvLastName = driver
						.findElement(By.xpath("//*[@id=\"rejectedInvRequestDetailsJtable\"]/div/table/tbody/tr/td[3]"))
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (perPageNoOfRecordsPresent > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String InvFirstName = driver.findElement(By.xpath(
								"//*[@id=\"rejectedInvRequestDetailsJtable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
								.getText();// documentTypeName
						System.out.println("InvReviewFullName: " + InvFirstName);
						if (InvLastName.equalsIgnoreCase(InvFirstName)) {
							driver.findElement(
									By.xpath("//*[@id=\"rejectedInvRequestDetailsJtable\"]/div/table/tbody/tr[ " + i
											+ " ]/td[3]"))
									.click();
					...
					String InvReviewFullName = driver
							.findElement(
									By.xpath("//*[@id=\"rejectedInvRequestDetailsJtable\"]/div/table/tbody/tr/td[3]"))
							.getText();
				...
				if ((!recordSelectedForInv) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#rejectedInvRequestDetailsJtable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
							.click();// next page in Document approve list
					Thread.sleep(5000);
					table = driver.findElement(By.id("rejectedInvRequestDetailsJtable"));// Document Tree approve table
