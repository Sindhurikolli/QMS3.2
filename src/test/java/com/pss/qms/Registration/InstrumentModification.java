...
public class InstrumentModification extends RegistrationLoginDetails {
   ...
   @Test
    public void ProductRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("modifySelectionInInstrument")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"existingInstrumentViewRegister\"]/div/div[4]/table/tbody/tr[1]/td[3]")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.id("instmtIdInInstReg")).clear();
        Thread.sleep(4000);
