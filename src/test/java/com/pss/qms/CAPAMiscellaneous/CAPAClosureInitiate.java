 ...
 * @author Mounika
 */
public class CAPAClosureInitiate extends CAorPALoginDetails {

    
     @Test
    public void CAPAClosureInitiate() throws InterruptedException {
        Thread.sleep(10000);
        ...
        Thread.sleep(20000);
        methodToDoCAPAClosureInitiate();
    }

    private void methodToDoCAPAClosureInitiate() throws InterruptedException {
        int count = 0;
...
//        isRecordSelected = selectRecdCAPAClosureInitiate(CAPANumber, isRecordSelected, count);
...
//            Thread.sleep(3000);
            ...
            Thread.sleep(1000);  
            driver.findElement(By.id("locTreeInQmsLifeCycleSel_3_span")).click();
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
            driver.findElement(By.id("capaCloserComments")).sendKeys(properties.getProperty("Task_Description"));
            Thread.sleep(1000);
    ...
    private boolean selectRecdCAPACompletionApproval(String CAPANumber, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0) {
        	WebElement elementshowing = driver.findElement(By.xpath("//*[@id=\"capaCloseTableContainer\"]/div/div[4]/div[2]/span"));
            JavascriptExecutor jsshow = (JavascriptExecutor)driver;
            jsshow.executeScript("arguments[0].scrollIntoView(true);", elementshowing);
            String a = driver.findElement(By.xpath("//*[@id=\"capaCloseTableContainer\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                    	WebElement elementsele = driver.findElement(By.xpath("//*[@id=\"capaCloseTableContainer\"]/div/table/tbody/tr/td[3]"));
                        JavascriptExecutor jssel = (JavascriptExecutor)driver;
                        jssel.executeScript("arguments[0].scrollIntoView(true);", elementsele);
                        String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"capaCloseTableContainer\"]/div/table/tbody/tr/td[3]")).getText();//documentTypeName
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    ...
                    Thread.sleep(3000);
                    table = driver.findElement(By.id("capaCloseTableContainer"));//Document Tree approve table
