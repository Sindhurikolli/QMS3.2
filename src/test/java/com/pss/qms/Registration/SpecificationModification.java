 ...
 * @author likhitha
 */
public class SpecificationModification extends RegistrationLoginDetails {
    ...
    public void SpecificationRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAddMenusListId\"]/ul/li[3]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.id("modifySelectionInSpecification")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"existingSpecificationGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(10000);
       driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
        Thread.sleep(10000);
      driver.findElement(By.id("specIdInRegSpecification")).clear();
        Thread.sleep(4000);
        driver.findElement(By.id("specIdInRegSpecification")).sendKeys(properties.getProperty("SPEC_ID"));
        Thread.sleep(4000);
//        driver.findElement(By.id("proBrowBtnInRegSpecificationAdd")).click();
//        Thread.sleep(4000);
//        driver.findElement(By.xpath("//*[@id=\"ProSelRegSpecAddWinTable\"]/div/div[4]/table/tbody/tr[8]/td[2]")).click();
//        Thread.sleep(4000);
//        driver.findElement(By.id("prodSelBtnIdInSpecReg")).click();
//        Thread.sleep(4000);
        driver.findElement(By.id("selAppBtnInRegSpecAdd")).click();
        Thread.sleep(4000);
...
//            Thread.sleep(3000);
             ...
             Thread.sleep(5000);
//        driver.findElement(By.id("descInRegSpecification")).sendKeys(properties.getProperty("SPEC_DESC"));
//        Thread.sleep(4000);
        driver.findElement(By.id("submitBtnInRegSpecificationAdd")).click();
        Thread.sleep(4000);
