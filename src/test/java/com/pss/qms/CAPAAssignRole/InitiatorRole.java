...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("InitiatorRole", "PSS-QMS-050",
					"Pass");
...
//       Thread.sleep(3000);
       ...
       sno++;
        ...
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select role from non-selected list",sno,false);
         Thread.sleep(3000);
