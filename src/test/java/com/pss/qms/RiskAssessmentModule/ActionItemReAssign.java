...
public class ActionItemReAssign extends RALoginDetails {

    @Test
    public void ActionItemReAssignRA() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
	  	...
	  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemReAssign", "PSS-QMS-001",
					"Pass");
    ...
    driver.findElement(By.xpath("//*[@id=\"loginform\"]/div[7]/button[1]")).click();
     ...
     im = Image.getInstance(input);
         ...
         WebElement element = driver.findElement(By.xpath("//*[@id=\"actionItemsGroupMenuId\"]/div[2]/a"));
         jse.executeScript("arguments[0].scrollIntoView(true);", element);
         Thread.sleep(1000);
             sno++;
             Thread.sleep(5000);
         driver.findElement(By.xpath("//*[@id=\"actionItemsGroupMenuId\"]/div[2]/a")).click();
...
//	}
    ...
    private void methodToDoActionItemReAssign() throws Exception {
        ...
        isRecordSelected = selectRecdActionItemReAssign(RASequence, isRecordSelected, count);
        Thread.sleep(1000);
        if (isRecordSelected) {
            ...
            String UserFirstName = properties.getProperty("UserName3");
          ...
          Thread.sleep(3000);
          sno++;
            driver.findElement(By.id("commentsInRAActItmPerform")).sendKeys(properties.getProperty("RA_SHORT_DESCRIPTION"));
	...
	private boolean selectRecdActionItemReAssign(String RANumber, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"riskAssessmentActItmPerFormTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
            String[] parts = a.split(" of ");
            try {
                totalNoOfRecords = Integer.parseInt(parts[1].trim());
            } catch (Exception e) {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((RANumber == null) || ("".equalsIgnoreCase(RANumber)))) {
                RANumber = driver.findElement(By.xpath("//*[@id=\"riskAssessmentActItmPerFormTable\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((RANumber == null) || ("".equalsIgnoreCase(RANumber))) {
                RANumber = driver.findElement(By.xpath("//*[@id=\"riskAssessmentActItmPerFormTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String RANumberSequence = driver.findElement(By.xpath(".//*[@id='riskAssessmentActItmPerFormTable']/div/table/tbody/tr[ " + i + " ]/td[2]")).getText();//documentTypeName
                        if (RANumber.equalsIgnoreCase(RANumberSequence)) {
                            driver.findElement(By.xpath(".//*[@id='riskAssessmentActItmPerFormTable']/div/table/tbody/tr[ " + i + " ]/td[2]")).click();
                    ...
                    String RANumberSequence = driver.findElement(By.xpath(".//*[@id='riskAssessmentActItmPerFormTable']/div/table/tbody/tr/td[2]")).getText();
                    if (RANumber.equalsIgnoreCase(RANumberSequence)) {
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#riskAssessmentActItmPerFormTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next")).click();//next page in Document approve list
                    Thread.sleep(3000);
