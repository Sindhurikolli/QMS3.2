...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAHODRole", "PSS-QMS-057",
					"Pass");
...
//    }
    ...
    private void createRoleMethod() throws Exception {
        Thread.sleep(1000);
        sno++;
        driver.findElement(By.id("roleNameInCreateRoleInCapa")).sendKeys(properties.getProperty("Role_Name4"));
