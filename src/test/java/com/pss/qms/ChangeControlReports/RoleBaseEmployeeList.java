 ...
 * @author likhitha
 */
public class RoleBaseEmployeeList extends CCLoginDetails {
...
//        Thread.sleep(5000);
        driver.findElement(By.xpath("//*[@id=\"ccRoleBaseEmployeeListId\"]/a")).click();
        Thread.sleep(8000);
        driver.findElement(By.id("locBtn_CcRoleBaseEmpListMenu")).click();
        Thread.sleep(8000);
        driver.findElement(By.id("treeContainer_2_switch")).click();
        Thread.sleep(8000);
        driver.findElement(By.id("treeContainer_3_span")).click();
        ...
        driver.findElement(By.id("selectBtnInLocSelect")).click();
        Thread.sleep(8000);
        driver.findElement(By.id("viewReportBtnInCcRoleBaseEmpListMenu")).click();
        Thread.sleep(8000);
