 ...
 * @author likhitha
 */
public class CustomerReSubmitReject extends RegistrationLoginDetails {
   ...
   @Test
    public void CustomerRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("rejectSelectionInCustomer")).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"rejectedCustomerGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(8000);
