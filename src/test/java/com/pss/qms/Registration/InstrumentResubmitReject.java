 ...
 * @author likhitha
 */
public class InstrumentResubmitReject extends RegistrationLoginDetails  {
    
   @Test
    public void InstrumentRegistration() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("rejectSelectionInInstrument")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"rejectedInstrumentGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(10000);
