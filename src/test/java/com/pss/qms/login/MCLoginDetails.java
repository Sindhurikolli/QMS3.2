...
public class MCLoginDetails  {
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src/test/java/QMSUIProperties/MCproperties.properties";	
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("MCproperties.properties not found at " + propertyFilePath);
		}
