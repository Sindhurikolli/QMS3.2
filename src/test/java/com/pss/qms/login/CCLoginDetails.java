...
//	private static String loginUserPassword = System.getProperty("userpassword");
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src/test/java/QMSUIProperties/ChangeControl.properties";	
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("qmsUIProperties1.properties not found at " + propertyFilePath);
		}
