...
public class AdhocScheduleApproval extends AMLoginDetails {

	@Test
	public void PlanAuditApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("PlanAudit Approve", "PSS-QMS-002", "Pass");
