...
public class EffectiveCheckPerformAfterRejectByQMSCoordinator extends CAorPALoginDetails {

	@Test
	public void EffectiveCheckPerformAfterRejectByQMSCoordinator() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/"
				+ "EffectiveCheckPerformAfterRejectByQMSCoordinator" + (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("EffectiveCheckPerformAfterRejectByQMSCoordinator",
				"PSS-QMS-042", "Pass");
...
//        sno++;
//        Thread.sleep(15000);
//        driver.findElement(By.cssSelector("#capaEffectivePostPerformId > a")).click();
...
//           Thread.sleep(5000);
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Add suppoting doscuments", sno,
					false);
			sno++;
			driver.findElement(By.id("uploadSuppDocInEffChkPerform_1")).sendKeys(properties.getProperty("Document-3"));
