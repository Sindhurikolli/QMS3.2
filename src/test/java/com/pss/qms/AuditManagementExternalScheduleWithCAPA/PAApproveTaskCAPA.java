...
public class PAApproveTaskCAPA extends AMLoginDetails {
	 
	 @Test
	    public void methodtodoPAApproveTaskCAPA() throws InterruptedException, IOException, DocumentException, Exception {
//			try {

				document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "PAApproveTaskCAPA"
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("PAApproveTaskCAPA", "PSS-QMS-014",
						"Pass");
	     ...
	     im = Image.getInstance(input);
	         ...
	         sno++;
	         driver.findElement(By.xpath("//*[@id=\"paApproveMenuId\"]/a")).click();
	         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on PA Approve Menu",sno,false);
	        todoPAApproveTaskCAPA();
	        document.close();
			writer.close();
...
//		}
	    ...
	    private void todoPAApproveTaskCAPA() throws Exception {
	      
	    	 int count = 0;
	         boolean isRecordSelected = false;
	         String CAPANumber = properties.getProperty("CAPA_NUMBER_AM");
	         isRecordSelected = selectRecdPAApproveTaskCAPA(CAPANumber, isRecordSelected, count);
	         if (isRecordSelected) {
	             sno++;
	             driver.findElement(By.id("commentsInApproveForm")).sendKeys(properties.getProperty("Task_Desc_2000"));
	             document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter The Comments",sno,false);  
	             sno++;
	             driver.findElement(By.id("appBtnIdInPaTaskApp")).click();
...
//	             WebDriverWait wait = new WebDriverWait(driver, 60);
		...
		private boolean selectRecdPAApproveTaskCAPA(String CAPANumber, boolean isRecordSelected, int count) throws InterruptedException {
			  WebElement table = driver.findElement(By.id("paTaskApproveTable"));
		        WebElement tableBody = table.findElement(By.tagName("tbody"));
		        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		        int totalNoOfRecords = 0;
		        int noOfRecordsChecked = 0;
		        if (perPageNoOfRecordsPresent > 0) {
		            String a = driver.findElement(By.xpath("//*[@id=\"paTaskApproveTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
		        ...
		        if (perPageNoOfRecordsPresent > 0 && count == 0) {
		            if ((totalNoOfRecords > 1) && ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber)))) {
		            	CAPANumber = driver.findElement(By.xpath("//*[@id=\"paTaskApproveTable\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
		            } else if ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber))) {
		            	CAPANumber = driver.findElement(By.xpath("//*[@id=\"paTaskApproveTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
		            ...
		            while (noOfRecordsChecked < totalNoOfRecords) {
		                if (totalNoOfRecords > 1) {
		                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
		                        String capaNumberSequence = driver.findElement(By.xpath(".//*[@id='paTaskApproveTable']/div/table/tbody/tr[ " + i + "]/td[3]")).getText();//documentTypeName
		                        if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
		                            driver.findElement(By.xpath("//*[@id=\"paTaskApproveTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).click();
		                    ...
		                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"paTaskApproveTable\"]/div/table/tbody/tr/td[3]")).getText();
		                    if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
		                        driver.findElement(By.xpath("//*[@id=\"paTaskApproveTable\"]/div/table/tbody/tr/td[3]")).click();
		                        isRecordSelected = true;
		                        break;
		                    }
		                }
