...
public class QAApproverRejectMC extends MCLoginDetails {
    
    @Test
    public void QAApproverRejectMC() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(10000);
        methodToDoQAApproverRejectMC();
    }

    private void methodToDoQAApproverRejectMC() throws InterruptedException {
        int count = 0;
...
//        String DepartmentCode = properties.getProperty("DEPARTMENT_CODE_QMS");
        ...
        isRecordSelected = selectRecdQAApproverRejectMC(MCNumber, isRecordSelected, count);
        Thread.sleep(1000);
        if (isRecordSelected) {
            ...
            Thread.sleep(1000);
            driver.findElement(By.id("rejectActivityInCheckInMcQaFinalRev")).click();
            Thread.sleep(1000);
    ...
    private boolean selectRecdQAApproverRejectMC(String MCNumber, boolean isRecordSelected, int count) throws InterruptedException {
