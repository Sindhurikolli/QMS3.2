...
public class AdhocSchdRejectApprove extends AMLoginDetails {

	@Test
	public void toAdhocSchdRejectApprove() throws Exception {
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (AuditId.contains(AuditNumberSequence)) {
