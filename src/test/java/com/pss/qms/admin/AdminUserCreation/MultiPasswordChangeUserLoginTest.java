...
public class MultiPasswordChangeUserLoginTest{
    ...
    public void toMultiUserCreation(String PassWordChangeUserID, String UserOlDPASSWORD, String UsernewPassword) throws Throwable {
        Thread.sleep(1000);


		Thread.sleep(5000);
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\test\\java\\QMSUIProperties\\adminproperties.properties");
		properties.setProperty("PassWordChangeUserID", PassWordChangeUserID);
		properties.setProperty("UserOlDPASSWORD", UserOlDPASSWORD);
		properties.setProperty("UsernewPassword", UsernewPassword);
		properties.save();
		
        Thread.sleep(5000);
        AdminLoginDetails login = new AdminLoginDetails();
        login.setUp();
        System.out.println("User password change for - "+PassWordChangeUserID);
        PasswordChangeUserLogin changepass = new PasswordChangeUserLogin();
        changepass.LoginPassChange();
    ...
    public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
        ...
        XSSFSheet sh = wb.getSheet("UserPassWordChange");
