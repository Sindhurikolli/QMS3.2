...
public class AuditObservationsRejectedApprove extends AMLoginDetails {
	...
	@Test
	public void toAuditObservationsRejectedApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("EnterAuditObservationsReject Approve",
					"PSS-QMS-008", "Pass");
...
//	document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Audit Management Module",sno,false);
			...
			// MyActivities Tab",sno,false);
			Thread.sleep(3000);
			sno++;
			driver.findElement(By.id("enterAuditFindingsAuditMenuInAMCount")).click();
...
//	  document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Next Button",sno,false); 
			sno++;
			 driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
			 document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Next Button",sno,false);
//			driver.findElement(By.id("commentsInAmReviewAuditFindingForm")).sendKeys(properties.getProperty("AM_2000"));
			Thread.sleep(5000);
...
//			Thread.sleep(2000);
	...
	private boolean selectRecdAuditObsRejectApprove(String AuditId, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By
							.xpath("//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((AuditId == null) || ("".equalsIgnoreCase(AuditId)))) {
				AuditId = driver.findElement(By.xpath(
						"//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr/td[3]"))
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String PlanNumberSequence = driver.findElement(By
								.xpath("//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
								.getText();// documentTypeName
						if (AuditId.contains(PlanNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
									.click();
					...
					String PlanNumberSequence = driver.findElement(By.xpath(
							"//*[@id=\"rejectAuditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr/td[3]"))
							.getText();
					if (AuditId.contains(PlanNumberSequence)) {
						driver.findElement(By.xpath(
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#rejectAuditsContainerInEnterAuditFindingsForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
							.click();// next page in Document approve list
					Thread.sleep(3000);
					table = driver.findElement(By.id("rejectAuditsContainerInEnterAuditFindingsForm"));// Document Tree
																										// approve table
