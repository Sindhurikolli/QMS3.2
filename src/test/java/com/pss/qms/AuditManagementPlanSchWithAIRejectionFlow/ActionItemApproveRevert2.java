...
public class ActionItemApproveRevert2 extends AMLoginDetails {

	@Test
	public void toActionItemApproveRevert() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemApproveRevert", "PSS-QMS-019", "Pass");
