...
public class QAReviewerAfterNotifyCustomer extends RALoginDetails {

	@Test
	public void QAReviewAfterNotifyCustomer() throws Exception {

		document = new Document(PageSize.A4, 36, 36, 20, 20);
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReviewerAfterNotifyCustomer"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerAfterNotifyCustomer", "PSS-QMS-012", "Pass");
...
//         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);  
	...
	private void methodToDoQAReviewAfterNotifyCustomer() throws Exception {
...
//            WebElement element = driver.findElement(By.id("responseInRaNotifyCustWindow"));
//            jse.executeScript("arguments[0].scrollIntoView(true);", element);
			...
			Thread.sleep(1000);
			sno++;
			driver.findElement(By.id("custRevDocInRaNotifyCustWindow")).sendKeys(properties.getProperty("Document-1"));
