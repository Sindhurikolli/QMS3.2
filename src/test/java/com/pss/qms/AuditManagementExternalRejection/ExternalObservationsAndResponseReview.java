...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ExternalObs Review", "PSS-QMS-009", "Pass");
...
//	}
	...
	private void methodToDoExternalObsReview() throws Exception {

		Thread.sleep(3000);
		int count = 0;
		boolean isRecordSelected = false;
		String AuditId = properties.getProperty("EXTERNAL_AUDIT_PLAN_NAME_REJECTION");
		isRecordSelected = selectRecdExternalObsReview(AuditId, isRecordSelected, count);
		Thread.sleep(1000);
		sno++;
	...
	private boolean selectRecdExternalObsReview(String AuditId, boolean isRecordSelected, int count)
