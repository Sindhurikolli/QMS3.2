...
public class QAReviewWithInvMC extends MCLoginDetails {
    
    
      @Test
    public void QAReviewerMC() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(10000);
        methodToDoQAReviewerMC();
    }

    private void methodToDoQAReviewerMC() throws InterruptedException {
        int count = 0;
...
//        String DepartmentCode = properties.getProperty("DEPARTMENT_CODE_QMS");
        ...
        isRecordSelected = selectRecdQAReviewMC(MCNumber, isRecordSelected, count);
        Thread.sleep(8000);
        if (isRecordSelected) {
            Thread.sleep(3000);
            driver.findElement(By.id("invChildReqInMcReview")).click();
            Thread.sleep(4000);
            driver.findElement(By.id("reqDetInMcReview")).sendKeys(properties.getProperty("Compliant_Short_Description"));
            Thread.sleep(1000);
            ...
            Thread.sleep(4000);
            driver.findElement(By.id("locTreeForCftTeamInQmsMcReview_2_switch")).click();
            Thread.sleep(4000);
            driver.findElement(By.id("locTreeForCftTeamInQmsMcReview_3_span")).click();
            Thread.sleep(4000);
            driver.findElement(By.xpath(".//*[@id='cftTeamTableWindowContainer']/div/table/tbody/tr[1]/td[2]")).click();
            Thread.sleep(4000);
    ...
    private boolean selectRecdQAReviewMC(String MCNumber, boolean isRecordSelected, int count) throws InterruptedException {
