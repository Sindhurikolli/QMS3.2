...
public class InvestigationCFTReview extends InvestigationLoginDetails {
	...
	public void ReviewInvestigation() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "InvestigationCFTReview"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("InvestigationCFTReview", "PSS-QMS-001", "Pass");
