...
public class QAApproverRAModule extends RALoginDetails {

	@Test
	public void QAApproverRA() throws Exception {

		document = new Document(PageSize.A4, 36, 36, 20, 20);
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAApproverRAModule"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAApproverRAModule", "PSS-QMS-009", "Pass");
...
//         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);
	...
	private void methodToDoQAApproverRA() throws Exception {
		...
		isRecordSelected = selectRecdQAApproverRA(RASequence, isRecordSelected, count);
		Thread.sleep(1000);
		if (isRecordSelected) {
			sno++;
			driver.findElement(By.id("commentsInFinalQaCcReview")).sendKeys(properties.getProperty("RA_2000"));
	...
	private boolean selectRecdQAApproverRA(String RANumber, boolean isRecordSelected, int count)
...
//                            driver.findElement(By.xpath(".//*[@id='riskAnalysisReviewTableContainer']/div/table/tbody/tr[ " + i + "]/td[29]/button")).click();
					...
					if (RANumber.equalsIgnoreCase(RANumberSequence)) {
						driver.findElement(By
								.xpath(".//*[@id='riskAnalysisReviewTableContainer']/div/table/tbody/tr/td[29]/button"))
								.click();
						isRecordSelected = true;
						break;
					}
