...
public class ReviewAuditObservations extends AMLoginDetails {
	...
	@Test
	public void toReviewAuditObservations() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("Review Audit", "PSS-QMS-009", "Pass");
...
//		        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document,
					"Click on Audit Observations Review Menu", sno, false);
			methodToDoAuditPlan();
			Thread.sleep(3000);
			document.close();
			writer.close();
