...
public class SecondaryRootCauseAnalysis extends MCLoginDetails {
	...
	public void InvRootCauseAnalysisMCModule() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("SecondaryRootCauseAnalysis", "PSS-QMS-044", "Pass");
