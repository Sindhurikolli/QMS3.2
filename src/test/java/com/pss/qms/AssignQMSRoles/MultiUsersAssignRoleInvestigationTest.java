...
public class MultiUsersAssignRoleInvestigationTest{

	static File resultFile = new File("QMS User Details for Automation.xlsx");
    public static DataFormatter formatter = new DataFormatter();

    @Test(dataProvider = "readExcelFile")
    public void toMultiUserCreation(String InvestigationUserE_Code, String InvestigationRoleName ) throws Throwable {
      
        Thread.sleep(5000);
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\test\\java\\QMSUIProperties\\QMS.properties");
		properties.setProperty("InvestigationUserE_Code", InvestigationUserE_Code);
		properties.setProperty("InvestigationRoleName", InvestigationRoleName);
		properties.save();
		
        Thread.sleep(5000);
        QMSLoginDetails login = new QMSLoginDetails();
        login.setUp();
        System.out.println("Role Assigned for - "+InvestigationUserE_Code);
        InvestigationAssignRole role = new InvestigationAssignRole();
        role.InvestigationAssignRoleMethod();
    ...
    public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
        ...
        XSSFSheet sh = wb.getSheet("INVRole");
