...
public class AuditPlanTermination extends AMLoginDetails {
    
    @Test
    public void methodtodoAuditPlanTermination() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			document = new Document();
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AuditPlanTermination"
            ...
            writer.open();
            HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditPlan Termination", "PSS-QMS-001",
					"Pass");
...
//	}
    ...
    private void todoAuditPlanTermination() throws Exception {
...
//        Thread.sleep(8000);
    	sno++;
        driver.findElement(By.id("searchBtnInAuditPlanTerminateAuditSrch")).click();
        Thread.sleep(3000);
