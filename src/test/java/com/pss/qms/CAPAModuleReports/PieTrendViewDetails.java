 ...
 * @author Mounika
 */
public class PieTrendViewDetails extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "PieTrendViewDetails"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("PieTrendViewDetails", "PSS-QMS-020",
					"Pass");
