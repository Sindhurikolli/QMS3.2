...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeviationStatus"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeviationStatus", "PSS-QMS-001", "Pass");
...
//    Thread.sleep(5000);
    sno++;
    driver.findElement(By.id("searchBtn_DevStatusATPage")).click();
