...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemRePerform", "PSS-QMS-013", "Pass");
...
//	}
	...
	private void methodToDoAuditeeResponseApprove() throws Exception {
		...
		String AMId = properties.getProperty("External_AUDIT_NAME_WITH_AINO_REJECT_FLOW");
