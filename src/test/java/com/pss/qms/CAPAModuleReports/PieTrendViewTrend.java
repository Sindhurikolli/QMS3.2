 ...
 * @author Mounika
 */
public class PieTrendViewTrend extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "PieTrendViewTrend"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("PieTrendViewTrend", "PSS-QMS-020",
					"Pass");
        ...
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on capa trends menu",sno,false);
        Thread.sleep(4000);
        driver.findElement(By.cssSelector("#capaTrendsListMenuId > ul > li:nth-child(1) > a")).click();
          Thread.sleep(4000);
          methodtocapaTrends();
          document.close();
  		writer.close();
...
//  	}
		...
		private void methodtocapaTrends() throws Exception {
          driver.findElement(By.id("selLocBtnInCapaTrends")).click();
          Thread.sleep(4000);
...
//          Thread.sleep(4000);
          ...
          Thread.sleep(4000);
          driver.findElement(By.id("capaNumner_CapaPieTrendSearch")).sendKeys(properties.getProperty("CAPA_REPORT_NO"));
          Thread.sleep(4000);          
