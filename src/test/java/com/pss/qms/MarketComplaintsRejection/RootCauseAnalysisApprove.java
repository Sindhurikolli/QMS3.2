 ...
 * @author likhitha
 */
public class RootCauseAnalysisApprove extends MCLoginDetails {
	...
	public void InvRootCauseAnalysisMCModule() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RootCauseAnalysisApprove"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("RootCauseAnalysisApprove", "PSS-QMS-029", "Pass");
