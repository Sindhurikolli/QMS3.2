...
public class MCDocumentTerminate extends MCLoginDetails {
    ...
    private void methodToDoQAReviewerMC() throws InterruptedException {
        ...
        String chgCtrlNoWithPlantCode = MCDept + DepartmentCode + "-" + changeCtrlSequence;
        Date date = new Date();
        String sdf = new SimpleDateFormat("YY").format(date);
        String chgCtrlId = "-004";
        ...
        if (isRecordSelected) {
            ...
            Severity.selectByVisibleText(properties.getProperty("SEVERITY"));
            Thread.sleep(1000);
