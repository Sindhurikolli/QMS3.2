...
public class ActionItemPerformRejected extends RALoginDetails {
	...
	public void ActionItemPerformRA() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItemPerformRejected"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemPerformRejected", "PSS-QMS-001", "Pass");
