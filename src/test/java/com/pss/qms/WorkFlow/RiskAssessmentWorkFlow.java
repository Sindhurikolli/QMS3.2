...
public class RiskAssessmentWorkFlow extends QMSLoginDetails {

    @Test
    public void RiskAssessmentWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
		...
		Thread.sleep(5000);
		driver.findElement(By.id("workFlowInRA")).click();
        Thread.sleep(2000);
        toRiskAssessmentWorkFlowMethod();
        
            }

    private void toRiskAssessmentWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
     
        driver.findElement(By.id("locSelBtn_RaCreateWfUsersSearch")).click();
        Thread.sleep(3000);
        ...
        String DhodE_Codes = properties.getProperty("RADepartmentHodE_Codes");
        ...
        Thread.sleep(3000);
        String QMSCoordinatorE_Codes = properties.getProperty("RAQAReviewerE_Codes");
        ...
        jse.executeScript("window.scrollBy(0,250)");
        Thread.sleep(3000);
        String QAHODE_Codes = properties.getProperty("RAQAApproverE_Codes");
        ...
        Thread.sleep(3000);
        String QualityHeadE_Codes = properties.getProperty("RACQAApproverE_Codes");
        ...
        WebDriverWait wait = new WebDriverWait(driver, 60);
     	  ...
     	  Thread.sleep(2000);
     	  driver.findElement(By.xpath("/html/body/div[1]/header/nav/ul[3]/li[3]/a/span")).click();
          Thread.sleep(1000);
          driver.findElement(By.xpath("/html/body/div[1]/header/nav/ul[3]/li[3]/ul/li[3]/a")).click();
          Thread.sleep(1000);
