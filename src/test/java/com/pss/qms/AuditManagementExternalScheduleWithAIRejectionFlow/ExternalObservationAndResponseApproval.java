...
public class ExternalObservationAndResponseApproval extends AMLoginDetails {

	@Test
	public void toExternalObservationAndResponseApproval() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ExternalObservationsAndResponse Approval",
					"PSS-QMS-011", "Pass");
...
//			driver.findElement(By.id("externalAuditObserAndRespAppMenuInAmCount")).click();
