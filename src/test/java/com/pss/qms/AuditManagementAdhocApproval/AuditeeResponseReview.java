...
public class AuditeeResponseReview extends AMLoginDetails {
	...
	@Test
	public void toAuditeeResponseReview() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditResponseReview Approve", "PSS-QMS-008",
					"Pass");
...
//	}
	...
	private void methodToDoAuditResponseReviewApprove() throws Exception {
		...
		String AuditId = properties.getProperty("ADHOC_NAME_IN_ADHOC_SCHEDULE");
