...
public class ExternalScheduleAuditApprove extends AMLoginDetails {

	@Test
	public void toExternalScheduleAuditApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ExternalAudit Approve", "PSS-QMS-002", "Pass");
