 ...
 * @author likhitha
 */
public class MaterialReject extends RegistrationLoginDetails {
...
//        Thread.sleep(10000);
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAppMenusListId\"]/ul/li[2]/a")).click();
        Thread.sleep(10000);
        methodToDoMaterialRegistration();
    }

    private void methodToDoMaterialRegistration() throws InterruptedException {
        int count = 0;
...
//        String chgCtrlId = "-0013";
        ...
        isRecordSelected = selectRecdMaterialReg(chgControlNumber, isRecordSelected, count);
        Thread.sleep(10000);
        if (isRecordSelected) {
            driver.findElement(By.id("commentsInViewQmsMaterialApp")).sendKeys(properties.getProperty("PROD_COMMENTS"));
            Thread.sleep(4000);
            driver.findElement(By.id("rejectBtnRegMaterial")).click();
            Thread.sleep(3000);
    ...
    private boolean selectRecdMaterialReg(String chgControlNumber, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber)))) {
                chgControlNumber = driver.findElement(By.xpath(".//*[@id=\"qmsMaterialApprovalGrid\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber))) {
                chgControlNumber = driver.findElement(By.xpath("//*[@id=\"qmsMaterialApprovalGrid\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"qmsMaterialApprovalGrid\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();//documentTypeName
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"qmsMaterialApprovalGrid\"]/div/table/tbody/tr/td[3]")).getText();
                    if (chgControlNumber.equalsIgnoreCase(capaNumberSequence)) {
