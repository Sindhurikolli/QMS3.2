...
package com.pss.qms.MarketComplaintsWithoutInvestigationForward;
...
public class CFTReviewMCModule extends MCLoginDetails {

	@Test
	public void CFTReviewMCModule1() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CFTReviewMCModule" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFTReviewMCModule", "PSS-QMS-03", "Pass");
...
//					false);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='mcMyActCftReviewPage.do']")));
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#mcCFTReviewTable > div > div.jtable-busy-message[style='display: none;']")));
	...
	private boolean selectRecdCFTReviewerMC(String MCNumber, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"mcCFTReviewTable\"]/div/div[4]/div[2]/span")).getText();// For
																														// Ex:
																														// Showing
																														// 1-1
																														// of
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((MCNumber == null) || ("".equalsIgnoreCase(MCNumber)))) {
				MCNumber = driver.findElement(By.xpath("//*[@id=\"mcCFTReviewTable\"]/div/table/tbody/tr[1]/td[16]"))
						.getText();// documentType
			} else if ((MCNumber == null) || ("".equalsIgnoreCase(MCNumber))) {
				MCNumber = driver.findElement(By.xpath("//*[@id=\"mcCFTReviewTable\"]/div/table/tbody/tr/td[16]"))
						.getText();// documentType
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String capaNumberSequence = driver
								.findElement(
										By.xpath(".//*[@id='mcCFTReviewTable']/div/table/tbody/tr[ " + i + " ]/td[16]"))
								.getText();// documentTypeName
						if (MCNumber.contains(capaNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[@id=\"mcCFTReviewTable\"]/div/table/tbody/tr[ " + i + " ]/td[28]/button"))
									.click();
					...
					Thread.sleep(3000);
					String capaNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"mcCFTReviewTable\"]/div/table/tbody/tr/td[16]")).getText();
					Thread.sleep(3000);
					if (MCNumber.contains(capaNumberSequence)) {
						Thread.sleep(3000);
						driver.findElement(By.xpath("//*[@id=\"mcCFTReviewTable\"]/div/table/tbody/tr/td[28]/button"))
								.click();
						Thread.sleep(3000);
						isRecordSelected = true;
						break;
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#mcCFTReviewTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
