...
public class ExternalObsAndResponseApproveReject extends AMLoginDetails {

	@Test
	public void toExternalObsAndResponseApproveReject() throws Exception {

//		try {

			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ExternalObsAndResponseApproveReject"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ExternalAudit Approve", "PSS-QMS-010", "Pass");
...
//	      document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Approvals Menu",sno,false); 
			...
			WebElement element = driver.findElement(By.cssSelector("a[href='amExternalAuditObsAndResAppPage.do']"));
...
//	}
	...
	private boolean selectRecdExternalAuditApprove(String AuditId, boolean isRecordSelected, int count)
