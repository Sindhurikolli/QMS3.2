...
public class ModifyAuditPlan extends AMLoginDetails {
    ...
    @Test
    public void methodtoModifyAuditPlan() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
        ...
        sno++;
         driver.findElement(By.xpath("//*[@id=\"amModifyAuditPlanAuditTag\"]/a/span")).click();
...
//	}
    ...
    private void todoModifyAuditPlan() throws Exception {
...
//        Thread.sleep(8000);
    	sno++;
        driver.findElement(By.id("searchBtnInModifyAuditPlanAuditSrch")).click();
        Thread.sleep(3000);
