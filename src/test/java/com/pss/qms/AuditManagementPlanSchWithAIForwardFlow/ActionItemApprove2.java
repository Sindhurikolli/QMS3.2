...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItemApprove2"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemApprove2", "PSS-QMS-011", "Pass");
