...
public class HODReviewMCModule extends MCLoginDetails {

	@Test
	public void HODReviewMCModule1() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "HODReviewMCModule" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("HODReviewMCModule", "PSS-QMS-014", "Pass");
...
//				false);
	...
	private void methodToDoHODReviewerMC() throws Exception {
		...
		isRecordSelected = selectRecdHODReviewerMC(MarketComplaintsId, isRecordSelected, count);
...
//			Thread.sleep(2000);
//			sno++;
//			driver.findElement(By.id("uploadSuppDocHOD_1")).sendKeys(properties.getProperty("Document-2"));
//			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Upload the document", sno, false);
//			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("commentsInMcQaHod")).sendKeys(properties.getProperty("MC_994"));
	...
	private boolean selectRecdHODReviewerMC(String MCNumber, boolean isRecordSelected, int count)
