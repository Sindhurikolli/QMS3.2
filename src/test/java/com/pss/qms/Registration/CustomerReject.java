...
public class CustomerReject extends RegistrationLoginDetails {
  ...
  @Test
    public void CustomerRegistrationApproval() throws InterruptedException {
        Thread.sleep(2000);
...
//        Thread.sleep(10000);
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAppMenusListId\"]/ul/li[8]/a")).click();
        Thread.sleep(10000);
...
//        String chgCtrlId = "-0013";
        ...
        Thread.sleep(10000);
        if (isRecordSelected) {
            driver.findElement(By.id("customerCommentsInViewCustApp")).sendKeys(properties.getProperty("PROD_COMMENTS"));
            Thread.sleep(4000);
            driver.findElement(By.id("rejCusAppView")).click();
            Thread.sleep(3000);
    ...
    private boolean selectRecdMCReports(String chgControlNumber, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber)))) {
                chgControlNumber = driver.findElement(By.xpath(".//*[@id=\"customerAppTableContainer\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber))) {
                chgControlNumber = driver.findElement(By.xpath("//*[@id=\"customerAppTableContainer\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"customerAppTableContainer\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).getText();//documentTypeName
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"customerAppTableContainer\"]/div/table/tbody/tr/td[4]")).getText();
                    if (chgControlNumber.equalsIgnoreCase(capaNumberSequence)) {
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.xpath(".//*[@id='customerAppTableContainer']/div/div[4]/div[1]/span[1]/span[4]")).click();//next page in Document approve list
                    Thread.sleep(3000);
