...
public class InvRootCauseAnalysisMCModule extends MCLoginDetails {
	...
	public void invRootCauseAnalysisMCModule() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "SecondaryInvRootCauseAnalysis"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("InvRootCauseAnalysisMCModule", "PSS-QMS-005", "Pass");
...
//    Thread.sleep(20000);
	...
	private void methodToDoInvestigationMC() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(4000);
			sno++;
			driver.findElement(By.id("rootCauseInrootCauseDlg")).sendKeys(properties.getProperty("MC_2000"));
