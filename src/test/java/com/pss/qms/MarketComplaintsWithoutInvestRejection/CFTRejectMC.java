...
public class CFTRejectMC extends MCLoginDetails {
	...
	public void CFTReviewMCModule1() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CFTRejectMC" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFT Reject MC", "PSS-QMS-005", "Pass");
...
//		String sdf = new SimpleDateFormat("YY").format(date);
		...
		if (isRecordSelected) {
			...
			Thread.sleep(1000);
			sno++;
			driver.findElement(By.id("rejectBtnInMcCFTReviewForm")).click();
