...
public class IncidentManagementLoginDetails {
...
public void setUp() throws Exception {
    ...
    propertyFilePathName = propertiesFilePath; 	
		...
		propertyFilePathName ="src/test/java/QMSUIProperties/IncidentManagement.properties";	
	}
	...
	try {
		...
		e.printStackTrace();
		throw new RuntimeException("IncidentManagement.properties not found at " + propertyFilePath);
	}
...
//		 dr.setVersion("91.0.4472.114");
	  ...
	  driver.manage().timeouts().implicitlyWait(120, TimeUnit.SECONDS);
        ...
        driver.manage().window().maximize();          
			...
			System.out.println("Specified Settints Are Invalid");
		}
