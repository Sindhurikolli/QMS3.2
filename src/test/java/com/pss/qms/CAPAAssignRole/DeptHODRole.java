...
public class DeptHODRole extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptHODRole"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptHODRole", "PSS-QMS-051",
					"Pass");
