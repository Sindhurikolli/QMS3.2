...
public class EffectiveCheckPerformAfterReject extends CAorPALoginDetails {
   ...
   public void CAPAEffectiveCheckImp() throws InterruptedException {
       ...
       Thread.sleep(6000);          
       driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformId\"]/a")).click();
       Thread.sleep(20000);
...
//           Thread.sleep(1000);
           driver.findElement(By.id("commentsInEffectiveCheckPostPerform")).sendKeys(properties.getProperty("Task_Description"));
           Thread.sleep(2000);
           driver.findElement(By.id("rePerformedcommentsInEffectiveCheckPostPerform")).sendKeys(properties.getProperty("Task_Description"));
           Thread.sleep(2000);
...
//           Thread.sleep(1000);
   ...
   private boolean selectRecdCAPAEffectiveCheckImp(String CAPANumber, boolean isRecordSelected, int count) throws InterruptedException {
       ...
       if (perPageNoOfRecordsPresent > 0) {
           String a = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
       ...
       if (perPageNoOfRecordsPresent > 0 && count == 0) {
           if ((totalNoOfRecords > 1) && ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber)))) {
               CAPANumber = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[1]/td[5]")).getText();//documentType
           } else if ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber))) {
               CAPANumber = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr/td[5]")).getText();//documentType
           ...
           while (noOfRecordsChecked < totalNoOfRecords) {
               if (totalNoOfRecords > 1) {
                   for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                       String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[" + i + " ]/td[5]")).getText();//documentTypeName
                       if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
                           driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[" + i + " ]/td[5]")).click();
                   ...
                   String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[1]/td[5]")).getText();
                   if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
                       driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[1]/td[5]")).click();
                       isRecordSelected = true;
                       break;
                   }
               }
