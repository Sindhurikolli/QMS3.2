 ...
 * @author likhitha
 */
public class RootCauseAnalysisReject extends MCLoginDetails {
	...
	public void RootCauseAnalysisReject() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RootCauseAnalysisReject"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("RootCauseAnalysisReject", "PSS-QMS-027", "Pass");
