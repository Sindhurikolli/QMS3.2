...
public class InvImpactAssessmentMCModule extends MCLoginDetails {

	@Test
	public void invImpactAssessmentMCModule() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "InvImpactAssessmentMCModule"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("InvImpactAssessmentMCModule", "PSS-QMS-006", "Pass");
