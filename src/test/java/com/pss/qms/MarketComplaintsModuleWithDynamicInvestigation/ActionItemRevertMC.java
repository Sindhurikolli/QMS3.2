...
public class ActionItemRevertMC extends MCLoginDetails {

	@Test
	public void ActionItemRevertMCMethod() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItemRevertMC"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemRevertMC", "PSS-QMS-017", "Pass");
		writer.setPageEvent(event);
		document.open();
		Thread.sleep(2000);
		driver.findElement(By.name("loginUserName")).sendKeys(properties.getProperty("AI_Approve_USER"));
		Thread.sleep(1000);
...
//    Thread.sleep(20000);
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#actItmApproveTable > div > div.jtable-busy-message[style='display: none;']")));
