...
public class ActionItemTermination extends AMLoginDetails {
...
//        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);
        sno++;
        driver.findElement(By.xpath("//*[@id=\"amActionItemsMenus\"]/div[8]/a")).click();
...
//        String sdf = new SimpleDateFormat("YY").format(date);
        ...
        if (isRecordSelected) {
          sno++;
            driver.findElement(By.id("reasonInActItemTerminateForm")).sendKeys(properties.getProperty("AUDIT_COMMENTS"));
...
//            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter The Comments "+"  PSS-QMS-SS-032",sno,false);
             driver.findElement(By.id("termBtnIdInAmActItmTerm")).click();
...
private boolean selectRecdActionItemTermination(String ActionItemNumber, boolean isRecordSelected, int count) throws InterruptedException {
        WebElement table = driver.findElement(By.id("actItmRecordInTerminateTable"));
        WebElement tableBody = table.findElement(By.tagName("tbody"));
        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
        int totalNoOfRecords = 0;
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((ActionItemNumber == null) || ("".equalsIgnoreCase(ActionItemNumber)))) {
            	ActionItemNumber = driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((ActionItemNumber == null) || ("".equalsIgnoreCase(ActionItemNumber))) {
            	ActionItemNumber = driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String AINumberSequence = driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();//documentTypeName
                        if (ActionItemNumber.equalsIgnoreCase(AINumberSequence)) {
                            driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).click();
                    ...
                    String AINumberSequence = driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/table/tbody/tr/td[3]")).getText();
                    if (ActionItemNumber.equalsIgnoreCase(AINumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"actItmRecordInTerminateTable\"]/div/table/tbody/tr/td[3]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#actItmRecordInTerminateTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next")).click();//next page in Document approve list
                    Thread.sleep(3000);
                    table = driver.findElement(By.id("actItmRecordInTerminateTable"));//Document Tree approve table
