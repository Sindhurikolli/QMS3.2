...
public class MultiUsersAssignRoleIncidentManagementTest{

	static File resultFile = new File("QMS User Details for Automation.xlsx");
    public static DataFormatter formatter = new DataFormatter();

    @Test(dataProvider = "readExcelFile")
    public void toMultiUserCreation(String IncidentManagementUserE_Code, String IncidentManagementRoleName ) throws Throwable {
        Thread.sleep(1000);


		Thread.sleep(5000);
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\test\\java\\QMSUIProperties\\QMS.properties");
		properties.setProperty("IncidentManagementUserE_Code", IncidentManagementUserE_Code);
		properties.setProperty("IncidentManagementRoleName", IncidentManagementRoleName);
		properties.save();
		
        Thread.sleep(5000);
        QMSLoginDetails login = new QMSLoginDetails();
        login.setUp();
        System.out.println("Role Assigned for - "+IncidentManagementUserE_Code);
        IncidentManagementAssignRole role = new IncidentManagementAssignRole();
        role.IncidentManagementAssignRoleMethod();
    ...
    public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
        ...
        XSSFSheet sh = wb.getSheet("INCRole");
