...
public class QMSCoOrdinatorRole extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QMSCoOrdinatorRole"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QMSCoOrdinatorRole", "PSS-QMS-056",
					"Pass");
...
//    }
    ...
    private void createRoleMethod() throws Exception {
        Thread.sleep(1000);
        sno++;
        driver.findElement(By.id("roleNameInCreateRoleInCapa")).sendKeys(properties.getProperty("Role_Name3"));
