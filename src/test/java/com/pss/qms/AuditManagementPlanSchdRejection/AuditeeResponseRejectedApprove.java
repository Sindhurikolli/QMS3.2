...
public class AuditeeResponseRejectedApprove extends AMLoginDetails {
	...
	@Test
	public void toAuditeeResponseRejectedApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponseReject Approve", "PSS-QMS-014",
					"Pass");
...
//            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Next Button",sno,false);
	...
	private boolean selectRecdAuditeeResponseRejectApprove(String AuditId, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By.xpath(
							"//*[@id=\"rejectAuditsContainerInReviewAuditResponseForm\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((AuditId == null) || ("".equalsIgnoreCase(AuditId)))) {
				AuditId = driver.findElement(By.xpath(
						"//*[@id=\"rejectAuditsContainerInReviewAuditResponseForm\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((AuditId == null) || ("".equalsIgnoreCase(AuditId))) {
				AuditId = driver
						.findElement(By.xpath(
								"//*[@id=\"rejectAuditsContainerInReviewAuditResponseForm\"]/div/table/tbody/tr/td[3]"))
						.getText();// documentType
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String AuditNumberSequence = driver.findElement(By
								.xpath(".//*[@id='rejectAuditsContainerInReviewAuditResponseForm']/div/table/tbody/tr[ "
										+ i + "]/td[3]"))
								.getText();// documentTypeName
						if (AuditId.equalsIgnoreCase(AuditNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[@id=\"rejectAuditsContainerInReviewAuditResponseForm\"]/div/table/tbody/tr[ "
											+ i + " ]/td[3]"))
									.click();
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#rejectAuditsContainerInReviewAuditResponseForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
							.click();// next page in Document approve list
					Thread.sleep(3000);
					table = driver.findElement(By.id("rejectAuditsContainerInReviewAuditResponseForm"));// Document Tree
																										// approve table
