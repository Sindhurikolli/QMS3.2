 ...
 * @author Mounika
 */
public class EffectiveCheckAfterRejectApproval extends CAorPALoginDetails {
    ...
    public void CAPAEffectiveCheckImp() throws InterruptedException {
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath("//*[@id=\"effectiveChkImplRejMenuId\"]/a")).click();
        Thread.sleep(4000);
...
//        String DepartmentCode = properties.getProperty("DEPARTMENT_CODE_QMS");
        ...
        String chgCtrlId = "-0080";
//        String number = "-CA-01";
        String CAPANumber = chgCtrlNoWithPlantCode + sdf + chgCtrlId + canumber;
    ...
    private boolean selectRecdCAPAEffectiveCheckImp(String CAPANumber, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber)))) {
                CAPANumber = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber))) {
                CAPANumber = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[1]/td[6]")).getText();
                    if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"capaEffectivePostPerformTable\"]/div/table/tbody/tr[1]/td[6]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
