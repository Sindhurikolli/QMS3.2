...
public class AdhocScheduleRejectApprove extends AMLoginDetails {

	@Test
	public void toAdhocScheduleRejectApprove() throws Exception {

//		try {

			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AdhocSchdRejectApprove"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AdhocSchdRejectApprove", "PSS-QMS-003", "Pass");
...
//	      document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);  
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Rejected RadioButton", sno,
					false);
			Helper.waitLoadRecords(driver, By.cssSelector("#rejectedAdhocAuditTablesContainer > div > div.jtable-busy-message[style='display: none;']"));
...
//	}
	...
	private void methodToDoPlanRejectApprove() throws Exception {
		...
		isRecordSelected = selectRecdAdhocRejectApprove(AuditId, isRecordSelected, count);
		Thread.sleep(2000);
		sno++;
	...
	private boolean selectRecdAdhocRejectApprove(String AuditId, boolean isRecordSelected, int count)
			throws InterruptedException {
		WebElement table = driver.findElement(By.id("rejectedAdhocAuditTablesContainer"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
//	        	WebElement element = driver.findElement(By.xpath("//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/div[4]/div[2]/span"));
//        	  JavascriptExecutor js = (JavascriptExecutor)driver;
//        	  js.executeScript("arguments[0].click();", element);
			String a = driver
					.findElement(By.xpath("//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((AuditId == null) || ("".equalsIgnoreCase(AuditId)))) {
				AuditId = driver
						.findElement(
								By.xpath("//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/table/tbody/tr/td[3]"))
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String AuditNumberSequence = driver.findElement(By.xpath(
								"//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
								.getText();// documentTypeName
						if (AuditId.equalsIgnoreCase(AuditNumberSequence)) {
							WebElement element = driver.findElement(
									By.xpath("//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/table/tbody/tr[ " + i
											+ " ]/td[3]"));
							JavascriptExecutor js = (JavascriptExecutor) driver;
							js.executeScript("arguments[0].click();", element);

//	                            driver.findElement(By.xpath("//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).click();
...
//	                        driver.findElement(By.xpath("//*[@id=\"rejectedAdhocAuditTablesContainer\"]/div/table/tbody/tr/td[3]")).click();
						isRecordSelected = true;
						break;
					}
				}
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#rejectedAdhocAuditTablesContainer > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
							.click();// next page in Document approve list
					Thread.sleep(3000);
					table = driver.findElement(By.id("rejectedAdhocAuditTablesContainer"));// Document Tree approve
																							// table
