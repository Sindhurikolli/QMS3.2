...
public class RoleBasePageAccess extends CAorPALoginDetails {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("RoleBasePageAccess", "PSS-QMS-48",
					"Pass");
        ...
        sno++;
        Thread.sleep(4000);
        driver.findElement(By.cssSelector("#side-menu > li:nth-child(1) > a"));
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Role base page access menu",sno,false);
...
// 	}
    ...
    private void todoRoleBasePageAccess() throws Exception {
        ...
        Roles.selectByIndex(7);
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select the roles from drop down list",sno,false);
        Thread.sleep(3000);
        sno++;
        driver.findElement(By.id("capaReviewMenu")).click();
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Check n capa review menu",sno,false);
        Thread.sleep(3000);
        sno++;
