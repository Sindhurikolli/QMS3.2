...
echo on
call xcopy "C:\Windows\System32\config\systemprofile\AppData\Local\Jenkins\.jenkins\QMS3.2\TestReport" "D:\PDFCopyFolder\QMS\Change Control\CC" /h /i /c /k /e /r /y
