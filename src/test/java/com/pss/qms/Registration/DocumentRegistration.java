 ...
 * @author likhitha
 */
public class DocumentRegistration extends RegistrationLoginDetails {

    @Test
    public void toDocumentRegistration() throws InterruptedException {
    	 Thread.sleep(2000);
         ...
         Thread.sleep(5000);
         driver.findElement(By.cssSelector("a[href='qmsDocumentReg.do']")).click();
         Thread.sleep(5000);
    ...
    public void todoDocumentRegistration() throws InterruptedException {   
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("descInRegDocumentAdd")).sendKeys(properties.getProperty("Document_Description"));
        Thread.sleep(4000);
