...
public class TerminatedActionItems extends AMLoginDetails {
    
    @Test
    public void methodtoTerminatedActionItems() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			document = new Document();
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminatedActionItems"
            ...
            writer.open();
            HeaderFooterPageEvent event = new HeaderFooterPageEvent("Terminated ActionItems", "PSS-QMS-001",
					"Pass");
        ...
        sno++;
         driver.findElement(By.xpath("//*[@id=\"amTerminatedActionItemsAuditForm\"]/a/span")).click();
         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Terminated ActionItems",sno,false);
        todoTerminatedActionItems();
        Thread.sleep(3000);
        document.close();
		writer.close();
...
//	}
    ...
    private void todoTerminatedActionItems() throws Exception {
...
//        Thread.sleep(8000);
    	sno++;
        driver.findElement(By.id("searchBtnInAmTermActItemAuditFormSrch")).click();
        Thread.sleep(3000);
