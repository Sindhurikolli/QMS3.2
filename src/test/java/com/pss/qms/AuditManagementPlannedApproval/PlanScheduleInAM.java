...
public class PlanScheduleInAM extends AMLoginDetails {

	@Test
	public void toPlanScheduleInAM() throws Exception {

//		try {

			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "PlanScheduleInAM"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("PlanScheduleInAM", "PSS-QMS-001", "Pass");
...
//	}
	...
	private void todoadhocScheduleAM() throws Exception {
		...
		driver.findElement(By.id("planNameInAmPlannedAuditForm"))
				.sendKeys(properties.getProperty("PLAN_NAME_PLAN_SCHEDULE"));
