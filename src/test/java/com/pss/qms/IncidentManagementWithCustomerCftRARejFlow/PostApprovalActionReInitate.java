...
//	    }
	    ...
	    private void  methodToDoPostApprovalActionsReInitiationIncident() throws Exception {
	        ...
	        isRecordSelected = selectRecdPostApprovalActionsDeviationDeviation(IncidentNumber, isRecordSelected, count);
	        if (isRecordSelected) {
	        	sno++;
	        	Thread.sleep(3000);
	        	JavascriptExecutor jse = (JavascriptExecutor)driver;
...
//	            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Add Button",sno,false);
	...
	private boolean selectRecdPostApprovalActionsDeviationDeviation(String IncidentNumber, boolean isRecordSelected, int count) throws InterruptedException {
