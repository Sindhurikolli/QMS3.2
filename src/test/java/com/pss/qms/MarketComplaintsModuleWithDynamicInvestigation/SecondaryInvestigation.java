...
public class SecondaryInvestigation extends MCLoginDetails {
	...
	public void InvestigationMC() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("SecondaryInvestigation", "PSS-QMS-010", "Pass");
...
//    Thread.sleep(20000);
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#investigationTableContainer > div > div.jtable-busy-message[style='display: none;']")));
...
//            Thread.sleep(4000);
			...
			WebElement element1 = driver.findElement(By.id("addSupDocsBtn_ForInvActionUpload_InvReviewPage"));
