...
public class CCClosedHistoryReportPrintPDF extends  CCLoginDetails {
...
//	            Thread.sleep(1000);
	          //  String windowHandleBefore = driver.getWindowHandle();
	            ...
	            WebElement element = driver.findElement(By.id("printPdfBtnInCcHistory"));
...
//	            Thread.sleep(6000);
	            String applicationWindowOrPDF = driver.getWindowHandle();
	                ...
	                Thread.sleep(3000);
	                driver.findElement(By.id("printPdfBtnInCcHistory")).click();
	                Thread.sleep(6000);
