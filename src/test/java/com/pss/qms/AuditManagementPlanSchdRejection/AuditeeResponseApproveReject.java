...
public class AuditeeResponseApproveReject extends AMLoginDetails {
	...
	@Test
	public void toAuditeeResponseApproveReject() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponseApprove Reject", "PSS-QMS-015",
					"Pass");
...
//            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Next Button",sno,false);
	...
	private boolean selectRecdAuditeeResponseApproveReject(String AuditId, boolean isRecordSelected, int count)
