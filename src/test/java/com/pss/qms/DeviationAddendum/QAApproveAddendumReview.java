 ...
 * @author likhitha
 */
public class QAApproveAddendumReview extends DeviationLoginDetails {
    
    
   @Test
    public void QAApproveAddendumDeviation() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(10000);
        methodToDoQAApproveAddendumDeviation();
    }
      
    private void  methodToDoQAApproveAddendumDeviation() throws InterruptedException {
        int count = 0;
...
//        String DepartmentCode = properties.getProperty("CHG_CONTROL_NO");
        ...
        isRecordSelected = selectRecdQAApproveAddendumDeviation(DeviationNumber, isRecordSelected, count);
        Thread.sleep(8000);
        if (isRecordSelected) {
...
private boolean selectRecdQAApproveAddendumDeviation(String DeviationNumber, boolean isRecordSelected, int count) throws InterruptedException {
