...
public class UserAssignRole extends RegistrationLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Thread.sleep(3000);
         driver.findElement(By.id("locationTreeForSingleUserSelect_7_ico")).click();
         Thread.sleep(3000);
...
//       Thread.sleep(3000);
       ...
       Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"bootstrap-duallistbox-nonselected-list_\"]/option[2]")).click();
         Thread.sleep(3000);
         driver.findElement(By.id("subBtnInAssignRoleReg")).click();
        Thread.sleep(3000); 
