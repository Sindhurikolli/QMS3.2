...
public class SecondaryInvRiskImapctAssessment extends MCLoginDetails {

	@Test
	public void SecondaryInvRiskImapctAssessment() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "SecondaryInvRiskImapctAssessment"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("SecondaryInvRiskImapctAssessment", "PSS-QMS-012",
				"Pass");
...
//  driver.findElement(By.cssSelector("a[href='invInvestigation.do']")).click();
	...
	private void methodToDoInvestigationMC() throws Exception {
		...
		if (isRecordSelected) {
			sno++;
			driver.findElement(By.id("impactAssessmentDescription")).sendKeys(properties.getProperty("MC_2000"));
...
//            driver.findElement(By.id("impAssQue2YesRadio")).click();
//            Thread.sleep(2000);
//            driver.findElement(By.id("impactAssQue2JustInDevReview")).sendKeys(properties.getProperty("Compliant_Short_Description"));
//            Thread.sleep(4000);
//            driver.findElement(By.id("impactAssessmentDescription")).sendKeys(properties.getProperty("Compliant_Short_Description"));
//            Thread.sleep(4000);
//            driver.findElement(By.id("impAssQue3YesRadio")).click();
//            Thread.sleep(2000);
//            driver.findElement(By.id("impactAssQue3JustInDevReview")).sendKeys(properties.getProperty("Compliant_Short_Description"));
//            Thread.sleep(4000);
//            driver.findElement(By.id("impAssQue4NoRadio")).click();
//            Thread.sleep(2000);
//            driver.findElement(By.id("uploadFileDocInImpactAssessment")).sendKeys(properties.getProperty("Document-1"));
//            Thread.sleep(4000);
			sno++;
			driver.findElement(By.id("submitIdInImpAssTabInvReview")).click();
				...
				if (totalNoOfRecords > 1) {
					...
					if (MCNumber.equalsIgnoreCase(capaNumberSequence)) {
						driver.findElement(By.xpath(
								".//*[@id='impactAssessmentInvTableContainer']/div/table/tbody/tr/td[20]/button"))
								.click();
						isRecordSelected = true;
						break;
					}
