...
public class AuditeeResponseApproval extends AMLoginDetails {
	...
	@Test
	public void AuditeeResponseApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponse Approve", "PSS-QMS-017", "Pass");
			...
			if ((totalNoOfRecords > 1) && ((AMId == null) || ("".equalsIgnoreCase(AMId)))) {
				AMId = driver
						.findElement(By.xpath(
								"//*[@id=\"auditsContainerInReviewAuditFindingAppForm\"]/div/table/tbody/tr[1]/td[5]"))
