...
public class CAPerformTaskCAPA extends AMLoginDetails {
...
//			try {
		  	...
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("CAPerformTaskCAPA", "PSS-QMS-011",
						"Pass");
	     ...
	     im = Image.getInstance(input);
	         ...
	         sno++;
	         driver.findElement(By.xpath("//*[@id=\"caPerformTaskMenuId\"]/a")).click();
...
//		}
	    ...
	    private void todoQAApproverCAPA() throws Exception {
	         ...
	         if (isRecordSelected) {
	        	 sno++;
	             driver.findElement(By.xpath("//*[@id=\"supportingDocsJtableInCaPerform\"]/div/div[3]/div[2]/span")).click();
	           ...
	           document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Select Button",sno,false); 
	             sno++;
	             driver.findElement(By.id("commentsInCaPerform")).sendKeys(properties.getProperty("Task_Desc_2000"));
		            ...
		            while (noOfRecordsChecked < totalNoOfRecords) {
		                if (totalNoOfRecords > 1) {
		                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
		                        String capaNumberSequence = driver.findElement(By.xpath(".//*[@id='usersTableContainer']/div/table/tbody/tr[ " + i + "]/td[1]")).getText();//documentTypeName
		                        if (UserFullName.equalsIgnoreCase(capaNumberSequence)) {
		                    ...
		                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[1]")).getText();
		                    if (UserFullName.equalsIgnoreCase(capaNumberSequence)) {
