...
//	private static String loginUserPassword = System.getProperty("userpassword");
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src/test/java/QMSUIProperties/RAproperties.properties";	
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("RAproperties.properties not found at " + propertyFilePath);
		}
