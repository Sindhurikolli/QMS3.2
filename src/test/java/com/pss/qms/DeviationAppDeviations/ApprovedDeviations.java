package com.pss.qms.DeviationAppDeviations;
...
public class ApprovedDeviations extends DeviationLoginDetails {
    ...
    public void ViewDeviation() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"approvedDeviationsMenu_Id\"]/a")).click();
        Thread.sleep(10000);
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        ...
                        if (DeviationNumber.equalsIgnoreCase(DevNumberSequence)) {
                            driver.findElement(By.xpath("//*[@id=\"approvedDeviationsDetailsContainer\"]/div/table/tbody/tr[ " + i + " ]/td[23]/button")).click();
                    ...
                    String DevNumberSequence = driver.findElement(By.xpath("//*[@id=\"approvedDeviationsDetailsContainer\"]/div/table/tbody/tr/td[12]")).getText();
                    if (DeviationNumber.equalsIgnoreCase(DevNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"approvedDeviationsDetailsContainer\"]/div/table/tbody/tr/td[23]/button")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.xpath("//*[@id=\"approvedDeviationsDetailsContainer\"]/div/div[4]/div[1]/span[1]/span[5]")).click();//next page in Document approve list
                    Thread.sleep(3000);
