...
public class CFTReviewer extends InvestigationLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(5000);
        driver.findElement(By.id("roleNameInCreateRoleInInv")).sendKeys(properties.getProperty("Role_Name3"));
        Thread.sleep(3000);
