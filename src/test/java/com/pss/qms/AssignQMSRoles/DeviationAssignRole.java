...
public class DeviationAssignRole extends QMSLoginDetails {

    @Test
    public void DeviationAssignRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
    ...
    private void toCreateUsers() throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("searchEmpCode_InSingleUserSelectDialog")).sendKeys(properties.getProperty("DeviationUserE_Code"));
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String RoleName = properties.getProperty("DeviationRoleName");
      ...
      {
    	  Roletoselect.selectByVisibleText(properties.getProperty("DeviationRoleName"));
    	  Thread.sleep(2000);
       ...
       WebDriverWait wait = new WebDriverWait(driver, 60);
   	   wait.until(ExpectedConditions.presenceOfElementLocated(By.id("eSignPwdInDevWnd")));
    	  driver.findElement(By.id("eSignPwdInDevWnd")).sendKeys(properties.getProperty("E_SignPassword"));
    	  Thread.sleep(1000);
