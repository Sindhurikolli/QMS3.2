...
public class CAPAAssignRole extends QMSLoginDetails {

    @Test
    public void CAPAAssignRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
    ...
    private void toCreateUsers() throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("searchEmpCode_InSingleUserSelectDialog")).sendKeys(properties.getProperty("CAPAUserE_Code"));
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String RoleName = properties.getProperty("CAPARoleName");
      ...
      {
    	  Roletoselect.selectByVisibleText(properties.getProperty("CAPARoleName"));
    	  Thread.sleep(2000);
