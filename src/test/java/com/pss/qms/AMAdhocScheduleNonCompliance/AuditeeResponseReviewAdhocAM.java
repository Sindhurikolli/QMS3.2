 ...
 * @author likhitha
 */
public class AuditeeResponseReviewAdhocAM extends AMLoginDetails {
    
	      @Test
	    public void AuditResponse() throws InterruptedException, IOException, DocumentException, Exception {
//			try {
				document = new Document(PageSize.A4, 36, 36, 20, 20);
			  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				document = new Document();
				output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AuditeeResponseReviewAdhocAM"
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponse Review", "PSS-QMS-008",
						"Pass");
...
//		}
	    ...
	    private void methodToDoAuditResponse() throws Exception {
	        int count = 0;
	        boolean isRecordSelected = false;

	        String AMId = properties.getProperty("ADHOC_NAME_ADHOC_SCHEDULE");

	        isRecordSelected = selectRecdAuditResponse(AMId, isRecordSelected, count);
	        Thread.sleep(4000);
	        if (isRecordSelected) {
	        	sno++;
	    ...
	    private boolean selectRecdAuditResponse(String AMId, boolean isRecordSelected, int count) throws InterruptedException {
