...
public class CloseAuditExternalSchedule extends AMLoginDetails {

	@Test
	public void CloseAudit() throws Exception {

//		try {

			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CloseAuditExternalSchedule"
...
//	}
	...
	private boolean selectRecdCloseAuditApprove(String AuditId, boolean isRecordSelected, int count)
