...
import com.pss.qms.util.DynamicBrowser;

public class VMLoginDetails {
...
//	private static String loginUserPassword = System.getProperty("userpassword");
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src/test/java/QMSUIProperties/VMproperties.properties";	
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("VMproperties.properties not found at " + propertyFilePath);
		}
...
//            RemoteWebDriver driver1=new RemoteWebDriver(new URL("http://192.168.1.49:4444/wd/hub"), dr);
             driver1=new RemoteWebDriver(new URL("http://192.168.1.49:4444/wd/hub"), dr);
            driver = driver1;
            ...
            driver.get(properties.getProperty("QMSRegistrationURL"));
