...
public class CFTReview extends MCLoginDetails {

	@Test
	public void CFTReview() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFTReviewMCModule", "PSS-QMS-007", "Pass");
...
//					false);
		...
		wait.until(ExpectedConditions.invisibilityOf(
				driver.findElement(By.cssSelector("#mcCFTReviewTable > div > div.jtable-busy-message"))));
	...
	private void methodToDoCFTReviewerMC() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("uploadSuppDocCFT_1")).sendKeys(properties.getProperty("Document-2"));
