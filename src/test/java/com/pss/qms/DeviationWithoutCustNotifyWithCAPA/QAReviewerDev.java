package com.pss.qms.DeviationWithoutCustNotifyWithCAPA;
...
//        String DeviationNumber = DeviationNumberToTrim.trim(); 
      ...
      Select Categoryofdeviation = new Select(driver.findElement(By.id("severityInDevPrim")));
          ...
          JavascriptExecutor jse = (JavascriptExecutor) driver;
            ...
            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On CFT RadioButton",sno,false);
            sno++;
        ...
        sno++;
            ...
            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Regulatory RadioButton",sno,false);
            ...
            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Add Regulatory Button",sno,false);
            sno++;
