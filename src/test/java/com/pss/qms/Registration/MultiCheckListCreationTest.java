...
public class MultiCheckListCreationTest{
    ...
    public void toMultiUserCreation(String CHECKLIST_NAME, String NoofCheckPoints) throws Throwable {
       
		Thread.sleep(5000);
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\test\\java\\QMSUIProperties\\Registration.properties");
		properties.setProperty("CHECKLIST_NAME", CHECKLIST_NAME);
		properties.setProperty("NoofCheckPoints", NoofCheckPoints);
        ...
        login.setUp();
        CheckListRegistration checklist = new CheckListRegistration();
        checklist.toCheckListRegistration(); 
        ChecklistApproval CheckApp = new ChecklistApproval();
        CheckApp.toChecklistApproval();
    ...
    public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
        ...
        XSSFSheet sh = wb.getSheet("CheckList");
