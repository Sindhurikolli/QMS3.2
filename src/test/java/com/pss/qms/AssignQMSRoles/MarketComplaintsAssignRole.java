...
public class MarketComplaintsAssignRole extends QMSLoginDetails {
    ...
    private void toCreateUsers() throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("searchEmpCode_InSingleUserSelectDialog")).sendKeys(properties.getProperty("MarketComplaintsUserE_Code"));
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String RoleName = properties.getProperty("MarketComplaintsRoleName");
      ...
      {
    	  Roletoselect.selectByVisibleText(properties.getProperty("MarketComplaintsRoleName"));
    	  Thread.sleep(2000);
