...
public class ActionItemPerform2 extends AMLoginDetails {
	...
	@Test
	public void toActionItemPerform2() throws Exception {

//		try {

			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItemPerform2"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemPerform2", "PSS-QMS-010", "Pass");
...
//	}
	...
	private void methodToDoAuditeeResponseApprove() throws Exception {
		...
		String AMId = properties.getProperty("PLAN_NAME_IN_AI2_PLAN_SCHEDULE_AINO");
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (AMId.equalsIgnoreCase(AMNumberSequence)) {
				            ...
				            js15.executeScript("arguments[0].click();", element2);
