...
//	}
	...
	private void methodToDoAuditeeResponseReject() throws Exception {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#auditsContainerInReviewAuditFindingAppForm > div > div.jtable-busy-message[style='display: none;']")));
		Thread.sleep(3000);
		int count = 0;
