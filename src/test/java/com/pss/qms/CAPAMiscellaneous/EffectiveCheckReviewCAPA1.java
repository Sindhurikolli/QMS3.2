 ...
 * @author Mounika
 */
public class EffectiveCheckReviewCAPA1 extends CAorPALoginDetails {
    ...
    public void CAPAEffectiveCheckImp() throws InterruptedException {
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath("//*[@id=\"effectiveNessCheckReviewId\"]/a")).click();
        Thread.sleep(20000);
...
//        String chgCtrlNoWithPlantCode = changeCtrlDept + "-" + capaSequence;
        ...
        if (isRecordSelected) {
            ...
            Thread.sleep(1000);
            driver.findElement(By.id("commentsInEfctChkPerformReview")).sendKeys(properties.getProperty("Task_Description"));
            Thread.sleep(1000);
    ...
    private boolean selectRecdCAPAEffectiveCheckImp(String CAPANumber, boolean isRecordSelected, int count) throws InterruptedException {
        WebElement table = driver.findElement(By.id("effnessCheckReviewTable"));
        WebElement tableBody = table.findElement(By.tagName("tbody"));
        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
        int totalNoOfRecords = 0;
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber)))) {
                CAPANumber = driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((CAPANumber == null) || ("".equalsIgnoreCase(CAPANumber))) {
                CAPANumber = driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/table/tbody/tr[ " + i + " ]/td[5]")).getText();//documentTypeName
                        if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
                            driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/table/tbody/tr[ " + i + " ]/td[5]")).click();
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/table/tbody/tr[1]/td[5]")).getText();
                    if (CAPANumber.equalsIgnoreCase(capaNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"effnessCheckReviewTable\"]/div/table/tbody/tr[1]/td[5]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    ...
                    Thread.sleep(3000);
                    table = driver.findElement(By.id("effnessCheckReviewTable"));//Document Tree approve table
