...
public class QAReReviewRAModule extends RALoginDetails {

	@Test
	public void QAReReviewRAModule() throws Exception {

		document = new Document(PageSize.A4, 36, 36, 20, 20);
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReReviewRAModule"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReReviewRAModule", "PSS-QMS-008", "Pass");
...
//        Thread.sleep(3000);
	...
	private void methodToDoQAReReviewRA() throws Exception {
		...
		isRecordSelected = selectRecdQAReReviewRA(RASequence, isRecordSelected, count);
		Thread.sleep(2000);
		if (isRecordSelected) {
			sno++;
			JavascriptExecutor jse = (JavascriptExecutor) driver;
			WebElement element = driver.findElement(By.id("reReviewCommentsInRiskAssQaReview"));
			...
			Thread.sleep(1000);
//            WebElement element1 = driver.findElement(By.id("reviewCompletedInPaQaReview"));
...
//            Thread.sleep(2000);
	...
	private boolean selectRecdQAReReviewRA(String RANumber, boolean isRecordSelected, int count)
