...
public class ActionItemReject extends AMLoginDetails {
 
	 @Test
	    public void toActionItemReject() throws InterruptedException, IOException, DocumentException, Exception {
//			try {
				document = new Document(PageSize.A4, 36, 36, 20, 20);
			  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				  document = new Document();
					output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItemReject"
					...
					writer.open();
					HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItem Reject", "PSS-QMS-011",
							"Pass");
...
//	    }
	    ...
	    private void methodToDoActionItem() throws Exception {
	        ...
	        if (isRecordSelected) {
	            ...
	            sno++;
	            driver.findElement(By.id("rejBtnIdInAmActItmApp")).click();
