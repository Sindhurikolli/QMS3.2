...
public class ActionItemPerformAfterRejectAtApprove extends CCLoginDetails {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemPerformAfterRejectAtApprove",
					"PSS-QMS-050", "Pass");
