 ...
 * @author likhitha
 */
public class WorkFlow extends RegistrationLoginDetails {
    ...
    public void WorkFlowRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAddMenusListId\"]/ul/li[16]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.id("nameInCreateWF")).sendKeys(properties.getProperty("WORKFLOW_NAME"));
        Thread.sleep(4000);
          Date date = new Date();
        String todaysDate = new SimpleDateFormat("dd/MM/yyyy").format(date);
        Thread.sleep(3000);
        driver.findElement(By.id("startDateInCreateWF")).sendKeys(todaysDate);
        Thread.sleep(3000);
        
//        driver.findElement(By.id("groupDescInCreateGrp")).sendKeys(properties.getProperty("GROUP_NAME"));
//        Thread.sleep(4000);
        driver.findElement(By.id("locSelBtnInCreateWF")).click();
        Thread.sleep(4000);
        ...
        Thread.sleep(4000);
         driver.findElement(By.id("descriptionInCreateWF")).sendKeys("Approve");
        Thread.sleep(4000);
        driver.findElement(By.id("addStageBtnInCreateWF")).click();
        Thread.sleep(4000);
        driver.findElement(By.id("stageNameInCreateWFWin")).sendKeys(properties.getProperty("WORKFLOW_NAME"));
        Thread.sleep(4000);
        Select ApprovalFrom = new Select(driver.findElement(By.id("reqAppFromInCreateWFWin")));
        ApprovalFrom.selectByIndex(1);
        Thread.sleep(3000);
        driver.findElement(By.id("stageDescInCreateWFWin")).sendKeys(properties.getProperty("WORKFLOW_NAME"));
        Thread.sleep(4000);
        Select UserGroup = new Select(driver.findElement(By.id("userGroupIdInCreateWFWin")));
        UserGroup.selectByIndex(5);
        Thread.sleep(3000);
        driver.findElement(By.id("createBtnInCreateWFWin")).click();
        Thread.sleep(4000);
        driver.findElement(By.id("submitBtnInCreateWF")).click();
        Thread.sleep(4000);
