...
public class ChangeControlPreCheckListMap extends QMSLoginDetails {

    @Test
    public void ChangeControlPreCheckListMapMethod() throws InterruptedException {
        Thread.sleep(1000);
        ...
        Thread.sleep(5000);
        toChangeControlPreCheckListMapMethod();
        
            }

    private void toChangeControlPreCheckListMapMethod() throws InterruptedException {
        Thread.sleep(1000);
       ...
       Thread.sleep(3000);           
       String PreCheckList = properties.getProperty("PreCheckList");
