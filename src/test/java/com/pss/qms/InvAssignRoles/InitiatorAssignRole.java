...
public class InitiatorAssignRole extends InvestigationLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Thread.sleep(3000);
         driver.findElement(By.id("locationTreeForSingleUserSelect_9_ico")).click();
         Thread.sleep(3000);
         boolean isRecordSelectedForUser = false;
//       String InvFirstName =properties.getProperty("First_Name1");
       String UserFirsrtName =properties.getProperty("FIRST_NAME1");
...
//       Thread.sleep(3000);
       ...
       Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"bootstrap-duallistbox-nonselected-list_\"]/option[4]")).click();
         Thread.sleep(3000);
...
private boolean selectingTheUser(String userFullName, boolean isRecordSelectedForUser, int count4) {
