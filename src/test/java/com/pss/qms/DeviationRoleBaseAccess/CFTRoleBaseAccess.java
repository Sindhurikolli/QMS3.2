...
public class CFTRoleBaseAccess extends DeviationLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Roles.selectByVisibleText(properties.getProperty("Role_Name6"));;
         Thread.sleep(3000);
         driver.findElement(By.id("devCFTReviewMenu")).click();
         Thread.sleep(3000); 
