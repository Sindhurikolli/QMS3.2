 ...
 * @author likhitha
 */
public class AuditObservationsReject extends AMLoginDetails {

	 @Test
	    public void methodtodoAuditObsReject() throws InterruptedException, IOException, DocumentException, Exception {
			try {
		  	...
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditObservations Reject", "PSS-QMS-001",
						"Pass");
...
private boolean selectRecdAuditObsReject(String AuditId, boolean isRecordSelected, int count) throws InterruptedException {
      ...
      while (noOfRecordsChecked < totalNoOfRecords) {
          if (totalNoOfRecords > 1) {
              for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                  String planNumberSequence = driver.findElement(By.xpath(".//*[@id='auditsContainerInEnterAuditFindingsForm']/div/table/tbody/tr[ " + i + "]/td[3]")).getText();//documentTypeName
              ...
              String planNumberSequence = driver.findElement(By.xpath("//*[@id=\"auditsContainerInEnterAuditFindingsForm\"]/div/table/tbody/tr/td[3]")).getText();
              if (AuditId.equalsIgnoreCase(planNumberSequence)) {
