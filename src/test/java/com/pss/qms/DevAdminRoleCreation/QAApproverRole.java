...
public class QAApproverRole extends DeviationLoginDetails {
	@Test
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
        driver.findElement(By.id("roleNameInCreateRoleInDev")).sendKeys(properties.getProperty("Role_Name4"));
        Thread.sleep(3000);
