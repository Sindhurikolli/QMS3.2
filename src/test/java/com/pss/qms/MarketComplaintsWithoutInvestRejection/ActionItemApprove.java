...
public class ActionItemApprove extends MCLoginDetails {
	...
	public void actionItemApprove() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemApprove", "PSS-QMS-012", "Pass");
...
//					false);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='mcActionItemApprove.do']")));
...
//        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("eSignPwdInWnd"))).sendKeys(properties.getProperty("Esign_Password"));
			...
			sno++;
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html/body/div[1]/header/nav/ul/li[2]/a/span")).click();
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String capaNumberSequence = driver
								.findElement(By
										.xpath("//*[@id=\"actItmApproveTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
					...
					Thread.sleep(3000);
					String capaNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"actItmApproveTable\"]/div/table/tbody/tr/td[3]"))
							.getText();
					Thread.sleep(3000);
					if (MarketComplaintsId.contains(capaNumberSequence)) {
						Thread.sleep(3000);
						driver.findElement(By.xpath("//*[@id=\"actItmApproveTable\"]/div/table/tbody/tr/td[3]"))
								.click();
						Thread.sleep(3000);
						isRecordSelected = true;
						break;
