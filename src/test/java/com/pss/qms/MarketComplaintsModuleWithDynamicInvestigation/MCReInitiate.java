...
public class MCReInitiate extends MCLoginDetails {
	...
	@Test
	public void toMCReInitiate() throws Exception {
		...
		if (perPageNoOfRecordsPresent > 0) {
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (MarketComplaintsId.equalsIgnoreCase(capaNumberSequence)) {
							driver.findElement(By
									.xpath("//*[@id=\"mcRejectTable\"]/div/table/tbody/tr[ " + i + " ]/td[14]/button"))
									.click();
					...
					if (MarketComplaintsId.equalsIgnoreCase(capaNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"mcRejectTable\"]/div/table/tbody/tr/td[14]/button"))
								.click();
						isRecordSelected = true;
						break;
					}
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					...
					JavascriptExecutor js = (JavascriptExecutor) driver;
					WebElement element = driver.findElement(By.cssSelector("#mcRejectTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"));// next page in Document approve list
