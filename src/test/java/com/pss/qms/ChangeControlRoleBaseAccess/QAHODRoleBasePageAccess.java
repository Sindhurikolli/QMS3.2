...
public class QAHODRoleBasePageAccess extends CCLoginDetails{
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Roles.selectByVisibleText(properties.getProperty("Role_Name4"));;
         Thread.sleep(3000);
         ...
         Thread.sleep(5000);
         driver.findElement(By.id("ccActionItemExtApproveMenu")).click();
         Thread.sleep(3000);
         driver.findElement(By.id("ccActItmOvrDueApproveMenu")).click();
         Thread.sleep(3000);
         JavascriptExecutor scl1 = ((JavascriptExecutor) driver);
         scl1.executeScript("window.scrollBy(0,500)");
         Thread.sleep(5000);
         driver.findElement(By.id("ccActItemReviewMenu")).click();
         Thread.sleep(3000); 
