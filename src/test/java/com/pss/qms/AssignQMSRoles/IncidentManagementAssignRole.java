...
public class IncidentManagementAssignRole extends QMSLoginDetails {

    @Test
    public void IncidentManagementAssignRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
		...
		Thread.sleep(5000);
		driver.findElement(By.id("adminInInc")).click();
        Thread.sleep(2000);
        toCreateUsers();
    ...
    private void toCreateUsers() throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.id("searchEmpCode_InSingleUserSelectDialog")).sendKeys(properties.getProperty("IncidentManagementUserE_Code"));
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String RoleName = properties.getProperty("IncidentManagementRoleName");
      ...
      {
    	  Roletoselect.selectByVisibleText(properties.getProperty("IncidentManagementRoleName"));
    	  Thread.sleep(2000);
       ...
       WebDriverWait wait = new WebDriverWait(driver, 60);
   	   wait.until(ExpectedConditions.presenceOfElementLocated(By.id("eSignPwdInIncWnd")));
    	  driver.findElement(By.id("eSignPwdInIncWnd")).sendKeys(properties.getProperty("E_SignPassword"));
    	  Thread.sleep(1000);
