...
public class AuditPlanTerminateReject extends AMLoginDetails {
    
	   @Test
		    public void AuditPlanTerminationReject() throws InterruptedException, IOException, DocumentException, Exception {
//				try {
					document = new Document(PageSize.A4, 36, 36, 20, 20);
				  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
					  document = new Document();
						output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AuditPlanTerminateReject"
						...
						writer.open();
						HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditPlan Termination Reject", "PSS-QMS-011",
								"Pass");
...
//		        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Action Item Menu",sno,false);
		        ...
		        methodToDoAuditPlanTerminateReject();
		        Thread.sleep(3000);
		        document.close();
		      		writer.close();
...
//		      	}
		    ...
		    private void methodToDoAuditPlanTerminateReject() throws Exception {
		        int count = 0;
		        boolean isRecordSelected = false;
		       
		        String AuditPlanName = properties.getProperty("AUDIT_PLAN_NAME");
		        isRecordSelected = selectRecdAuditPlanTerminateReject(AuditPlanName,isRecordSelected, count);
		        Thread.sleep(3000);
		        if (isRecordSelected) {
		            sno++;
		            ...
		            sno++;
		            driver.findElement(By.id("rejectBtnInAuditTerminateApp")).click();
		    ...
		    private boolean selectRecdAuditPlanTerminateReject(String AuditPlanName, boolean isRecordSelected, int count) throws InterruptedException {
		            ...
		            while (noOfRecordsChecked < totalNoOfRecords) {
		                if (totalNoOfRecords > 1) {
		                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
		                        String AuditPlanSequence = driver.findElement(By.xpath("//*[@id=\"auditTerminateAppTableContainer\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).getText();//documentTypeName
		                    ...
		                    String AuditPlanSequence = driver.findElement(By.xpath("//*[@id=\"auditTerminateAppTableContainer\"]/div/table/tbody/tr/td[4]")).getText();
		                    if (AuditPlanName.equalsIgnoreCase(AuditPlanSequence)) {
