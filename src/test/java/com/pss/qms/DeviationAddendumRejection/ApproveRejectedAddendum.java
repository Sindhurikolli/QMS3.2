 ...
 * @author likhitha
 */
public class ApproveRejectedAddendum extends DeviationLoginDetails {
    ...
    public void AddendumDeviation() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"devAddendumListId\"]/ul/li[2]/a")).click();
        Thread.sleep(10000);
...
//        String DepartmentCode = properties.getProperty("CHG_CONTROL_NO");
        ...
        Thread.sleep(8000);
        if (isRecordSelected) {
            driver.findElement(By.xpath("//*[@id=\"devAddendumRejectForm\"]/div[3]/ul/li[2]/a")).click();
            Thread.sleep(5000);
...
//            Thread.sleep(5000);
            ...
            DeptReview.selectByIndex(1);
            Thread.sleep(4000);
            Select QAReview = new Select(driver.findElement(By.id("selectAddendumReviweStage3")));
            QAReview.selectByIndex(1);
            Thread.sleep(4000);
            Select DeptHOD = new Select(driver.findElement(By.id("selectAddendumReviweStage5")));
            DeptHOD.selectByIndex(1);
            Thread.sleep(4000);
//            Select QAApprove = new Select(driver.findElement(By.id("selectAddendumReviweStage5")));
//            QAApprove.selectByIndex(1);
//            Thread.sleep(4000);
            driver.findElement(By.xpath("//*[@id=\"devAddendumRejectForm\"]/div[3]/ul/li[3]/a")).click();
            Thread.sleep(5000);
...
private boolean selectRecdDeptReviewDeviation(String DeviationNumber, boolean isRecordSelected, int count) throws InterruptedException {
        WebElement table = driver.findElement(By.id("addendumRejectRecInDevRejectMenu"));
        WebElement tableBody = table.findElement(By.tagName("tbody"));
        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
        int totalNoOfRecords = 0;
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath(".//*[@id='addendumRejectRecInDevRejectMenu']/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((DeviationNumber == null) || ("".equalsIgnoreCase(DeviationNumber)))) {
                DeviationNumber = driver.findElement(By.xpath("//*[@id=\"addendumRejectRecInDevRejectMenu'\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((DeviationNumber == null) || ("".equalsIgnoreCase(DeviationNumber))) {
                DeviationNumber = driver.findElement(By.xpath("//*[@id=\"addendumRejectRecInDevRejectMenu'\"]/div/table/tbody/tr/td[3]")).getText();//documentType
  ...
  String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"addendumRejectRecInDevRejectMenu\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).getText();//documentTypeName
                        if (DeviationNumber.equalsIgnoreCase(capaNumberSequence)) {
                            driver.findElement(By.xpath("//*[@id=\"addendumRejectRecInDevRejectMenu\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).click();
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"addendumRejectRecInDevRejectMenu\"]/div/table/tbody/tr/td[4]")).getText();
                    if (DeviationNumber.equalsIgnoreCase(capaNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"addendumRejectRecInDevRejectMenu\"]/div/table/tbody/tr/td[4]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#addendumRejectRecInDevRejectMenu' > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next")).click();//next page in Document approve list
                    Thread.sleep(3000);
                    table = driver.findElement(By.id("addendumRejectRecInDevRejectMenu'"));//Document Tree approve table
