...
public class CQAApproverRAModule extends RALoginDetails {

	@Test
	public void CQAApproverRAModule() throws Exception {

		document = new Document(PageSize.A4, 36, 36, 20, 20);
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CQAApproverRAModule"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CQAApproverRAModule", "PSS-QMS-010", "Pass");
	...
	private void methodToDoCQAApproverRA() throws Exception {
		...
		scl.executeScript("window.scrollBy(0,750)");
		int count = 0;
