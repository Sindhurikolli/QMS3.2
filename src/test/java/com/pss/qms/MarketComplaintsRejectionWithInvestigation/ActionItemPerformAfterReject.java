...
public class ActionItemPerformAfterReject extends MCLoginDetails {

	@Test
	public void ActionItemPerformMC() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemPerformAfterReject", "PSS-QMS-056", "Pass");
...
//				false);
	...
	private void methodToDoAIPerformMC() throws Exception {
		...
		if (isRecordSelected) {
			...
			ApproveFromDropDown.selectByIndex(4);
			sno++;
			Thread.sleep(5000);
			driver.findElement(By.id("commentsInRejectForm")).sendKeys(properties.getProperty("MC_2000"));
			...
			sno++;
			Thread.sleep(2000);
			WebDriverWait wai1t = new WebDriverWait(driver, 70);
			wai1t.until(
