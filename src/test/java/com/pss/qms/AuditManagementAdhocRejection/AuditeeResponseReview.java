...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditResponseReview Approve", "PSS-QMS-015",
					"Pass");
...
//      document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);  
			Thread.sleep(3000);
			sno++;
			driver.findElement(By.id("auditeeResReviewAuditMenuInAM")).click();
