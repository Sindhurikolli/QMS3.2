 ...
 * @author Mounika
 */
public class WorkFlowUsers extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "WorkFlowUsers"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("WorkFlowUsers", "PSS-QMS-077",
					"Pass");
...
//        Thread.sleep(4000);
        sno++;
        driver.findElement(By.xpath("//*[@id=\"caPaWorkFlowAuditTrailsGridId\"]/div/table/tbody/tr[1]/td[10]/button")).click();
