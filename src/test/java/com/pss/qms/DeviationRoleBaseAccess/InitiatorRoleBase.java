...
public class InitiatorRoleBase extends DeviationLoginDetails {
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Roles.selectByIndex(13);
         Thread.sleep(5000);
         driver.findElement(By.id("devInitiateMenu")).click();
         Thread.sleep(5000); 
         driver.findElement(By.id("saveAsDraftMenu")).click();
         Thread.sleep(5000); 
         driver.findElement(By.id("devRejectMenu")).click();
         Thread.sleep(5000); 
         driver.findElement(By.id("devDelayedDevMenu")).click();
         Thread.sleep(5000); 
         driver.findElement(By.id("viewDeviationsMenu")).click();
         Thread.sleep(5000); 
         driver.findElement(By.id("devExtendDueDateMenu")).click();
         Thread.sleep(5000); 
         driver.findElement(By.id("initiateDeviationApprovedActions")).click();
         Thread.sleep(5000); 
