...
public class ActionItems  extends AMLoginDetails {
    
    @Test
    public void methodtoActionItems() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			document = new Document();
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItems"
            ...
            writer.open();
            HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItems", "PSS-QMS-001",
					"Pass");
        ...
        sno++;
         driver.findElement(By.xpath("//*[@id=\"amActionItemsAuditForm\"]/a/span")).click();
...
//	}
    ...
    private void todoActionItems() throws Exception {
...
//        Thread.sleep(8000);
    	sno++;
        driver.findElement(By.id("srchBtnInAmActItemsAuditForm")).click();
        Thread.sleep(3000);
