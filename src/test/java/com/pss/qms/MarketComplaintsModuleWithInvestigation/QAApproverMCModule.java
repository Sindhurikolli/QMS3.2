...
public class QAApproverMCModule extends MCLoginDetails {
  
    @Test
    public void QAApproverMC() throws InterruptedException {
        Thread.sleep(2000);
...
//        Thread.sleep(10000);
        ...
        Thread.sleep(10000);
        methodToDoQAApproverMC();
    }

    private void methodToDoQAApproverMC() throws InterruptedException {
        int count = 0;
...
//        String DepartmentCode = properties.getProperty("CHG_CONTROL_NO");
        ...
        isRecordSelected = selectRecdQAApproverMC(MCNumber, isRecordSelected, count);
        Thread.sleep(8000);
        if (isRecordSelected) {
            Thread.sleep(3000);
...
//            Thread.sleep(3000);
    ...
    private boolean selectRecdQAApproverMC(String MCNumber, boolean isRecordSelected, int count) throws InterruptedException {
