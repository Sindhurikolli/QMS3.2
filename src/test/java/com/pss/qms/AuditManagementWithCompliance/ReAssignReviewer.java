...
public class ReAssignReviewer extends AMLoginDetails {
    
   @Test
    public void ReAssignReviewerAM() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			document = new Document();
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ReAssignReviewer"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ReAssignReviewer", "PSS-QMS-001",
					"Pass");
...
//	}
    ...
    private void methodToDoReAssignReviewer() throws Exception {
        int count = 0;
        boolean isRecordSelected = false;
         String AMId = properties.getProperty("PLAN_NAME_PLANNED_SCHEDULE");
        isRecordSelected = selectRecdReAssignReviewer(AMId, isRecordSelected, count);
        if (isRecordSelected) {
        	 sno++;  
           driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
           document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Next Button",sno,false);
           Thread.sleep(1000);
           driver.findElement(By.xpath("//*[@id=\"existingReviewerUsersForAuditors\"]/div/table/tbody/tr/td[1]/input")).click();
           sno++; 
	...
	private boolean selectRecdReAssignReviewer(String AMId, boolean isRecordSelected, int count) throws InterruptedException {
