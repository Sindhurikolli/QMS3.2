...
public class QMSCoOdinatorRole extends CAorPALoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QMSCoOdinatorRole"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QMSCoOdinatorRole", "PSS-QMS-052",
					"Pass");
