...
public class ReviewAuditeeResponse extends AMLoginDetails {

	@Test
	public void toReviewAuditeeResponse() throws Exception {

//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AuditResponseReview"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditResponseReview ", "PSS-QMS-008", "Pass");
...
//	}
	...
	private void methodToDoAuditResponseReviewApprove() throws Exception {
		...
		String AuditId = properties.getProperty("PLAN_NAME_IN_AI_PLAN_SCHEDULE");
