...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ExternalSchedule", "PSS-QMS-001", "Pass");
...
//	}
	...
	private void todoexternalScheduleAM() throws Exception {
		...
		driver.findElement(By.id("planNameInAmAdhocAuditForm"))
				.sendKeys(properties.getProperty("EXTERNAL_AUDIT_NAME_WITH_AI_REJECT_FLOW"));
