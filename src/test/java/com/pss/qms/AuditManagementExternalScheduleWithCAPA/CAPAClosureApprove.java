...
public class CAPAClosureApprove extends AMLoginDetails {
	 
	 @Test
	    public void methodtodoClosureApprove() throws InterruptedException, IOException, DocumentException, Exception {
//			try {

				document = new Document(PageSize.A4, 36, 36, 20, 20);
		  	Font font = new Font(Font.FontFamily.TIMES_ROMAN);
				output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CAPAClosureApprove"
				...
				writer.open();
				HeaderFooterPageEvent event = new HeaderFooterPageEvent("CAPAClosureApprove", "PSS-QMS-018",
						"Pass");
...
//		}
	    ...
	    private void todoCAPAClosureApprove() throws Exception {
	      
	    	 int count = 0;
	         boolean isRecordSelected = false;
	         String CAPANumber = properties.getProperty("CAPA_NUMBER_AM");
	         isRecordSelected = selectRecdCAPAClosureApprove(CAPANumber, isRecordSelected, count);
	         if (isRecordSelected) {
	           sno++;
	             driver.findElement(By.id("capaCloserApprovalComments")).sendKeys(properties.getProperty("Task_Desc_2000"));
...
//	             WebDriverWait wait = new WebDriverWait(driver, 60);
		...
		private boolean selectRecdCAPAClosureApprove(String CAPANumber, boolean isRecordSelected, int count) throws InterruptedException {
