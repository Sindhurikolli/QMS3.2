...
//			try {
     	...
     	writer = PdfWriter.getInstance(document, fos);
					...
					writer.open();
					HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItem Approve", "PSS-QMS-010",
							"Pass");
...
//	    }
	    ...
	    private void methodToDoActionItemPerform() throws Exception {
	        ...
	        if (isRecordSelected) {
	          sno++;
	            driver.findElement(By.id("commentsInApproveForm")).sendKeys(properties.getProperty("AUDIT_COMMENTS_1500"));
	            ...
	            while (noOfRecordsChecked < totalNoOfRecords) {
	                if (totalNoOfRecords > 1) {
	                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
	                        String AMNumberSequence = driver.findElement(By.xpath("//*[@id=\"actItmApproveTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();//documentTypeName
	                    ...
	                    String AMNumberSequence = driver.findElement(By.xpath("//*[@id=\"actItmApproveTable\"]/div/table/tbody/tr/td[3]")).getText();
	                    if (ActionItemNumber.equalsIgnoreCase(AMNumberSequence)) {
