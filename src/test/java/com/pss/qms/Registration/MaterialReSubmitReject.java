 ...
 * @author likhitha
 */
public class MaterialReSubmitReject extends RegistrationLoginDetails {
   ...
   @Test
    public void MaterialRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("rejectSelectionInMaterial")).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"rejectedMaterialGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(8000);
