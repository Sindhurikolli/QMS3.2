...
//			clickElement(driver,byObj);
//		Thread.sleep(20000);
//		}
//	 }
//    catch (org.openqa.selenium.NoSuchElementException e){
//       System.out.println("Review Button worked");
//    }
//	}
...
//	}
    ...
    public static boolean selectingSingleApprovalRecord(WebDriver driver, String selectingUserSingleApproval, boolean isRecordSelected, int count) throws InterruptedException {
...
//            String a = driver.findElement(By.className("jtable-page-info")).getText();// For Ex: Showing 1-1 of 1
            String a = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/div[4]/div[2]/span")).getText().toString();// For Ex: Showing 1-1 of 1
            String[] parts = a.split(" of ");
            totalNoOfRecords = Integer.parseInt(parts[1].trim());
        }
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((selectingUserSingleApproval == null) || ("".equalsIgnoreCase(selectingUserSingleApproval)))) {
                selectingUserSingleApproval = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr[1]/td[5]")).getText();
            } else if (selectingUserSingleApproval == null || ("".equalsIgnoreCase(selectingUserSingleApproval))) {
                selectingUserSingleApproval = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[5]")).getText();
            }                                                              
            ++count;
        }
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String selectingUser = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr[" + i + "]/td[5]")).getText();
                    ...
                    String selectingUser = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[5]")).getText();
                    if (selectingUserSingleApproval.equalsIgnoreCase(selectingUser)) {
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/div[4]/div[1]/span[1]/span[5]")).click();//next page in single approval
                    Thread.sleep(3000);
    ...
    public static boolean selectRecordFromItemDetails(WebDriver driver, String documentNo, boolean isRecordSelectedForItems, int count) throws InterruptedException {
        ...
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
            String[] parts = a.split(" of ");
            totalNoOfRecords = Integer.parseInt(parts[1].trim());
        }
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((documentNo == null) || ("".equalsIgnoreCase(documentNo)))) {
                String docWithVersion = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr[1]/td[3]")).getText();//Doc No
                String[] getDocNo = docWithVersion.split("-");
                documentNo = getDocNo[0];
            } else if ((documentNo == null) || ("".equalsIgnoreCase(documentNo))) {
                String docWithVersion = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr/td[3]")).getText();//Doc No
                String[] getDocNo = docWithVersion.split("-");
                documentNo = getDocNo[0];
            }
            ++count;
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String docWithVersion = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr[" + i + "]/td[3]")).getText();//Doc No
                        String[] getDocNo = docWithVersion.split("-");
                        String documentNumber = getDocNo[0];
                        if (documentNo.equalsIgnoreCase(documentNumber)) {
                            driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr[" + i + "]/td[3]")).click();
                    ...
                    String docWithVersion = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr/td[3]")).getText();
                    String[] getDocNo = docWithVersion.split("-");
                    String documentNumber = getDocNo[0];
                    if (documentNo.equalsIgnoreCase(documentNumber)) {
                        driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr/td[3]")).click();
                        isRecordSelectedForItems = true;
                        break;
                    }
                }
    ...
    public static boolean selectMultiItemDetails(WebDriver driver, String multiDocNoForItem, boolean isRecordSelectedForMultiItems, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((multiDocNoForItem == null) || ("".equalsIgnoreCase(multiDocNoForItem)))) {
                String docWithVersion = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr[1]/td[3]")).getText();
                String[] getDocNo = docWithVersion.split("-");       
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String docWithVersion = driver.findElement(By.xpath("//*[@id=\"MultiItemTableContainer\"]/div/table/tbody/tr[" + i + "]/td[3]")).getText();
                        String[] getDocNo = docWithVersion.split("-");
                ...
                if ((!isRecordSelectedForMultiItems) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#MultiItemTableContainer > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next")).click();//next page in Curricula Details list
                    Thread.sleep(3000);
    ...
    public static boolean selectRecordForWorkFlow(WebDriver driver, String workFlowName, boolean isRecordSelectedForWF, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((workFlowName == null) || ("".equalsIgnoreCase(workFlowName)))) {
                workFlowName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/div[4]/table/tbody/tr[1]/td[1]")).getText();//WorkFlow Name

            } else if ((workFlowName == null) || ("".equalsIgnoreCase(workFlowName))) {
                workFlowName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/div[4]/table/tbody/tr/td[1]")).getText();//WorkFlow Name
            }
            ++count;
        }
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String LMSWFName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/div[4]/table/tbody/tr[" + i + "]/td[1]")).getText();//WorkFlow Name
                        if (workFlowName.equalsIgnoreCase(LMSWFName)) {
                            driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/div[4]/table/tbody/tr[" + i + "]/td[1]")).click();
                    ...
                    String LMSWFName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/div[4]/table/tbody/tr/td[1]")).getText();
                    if (workFlowName.equalsIgnoreCase(LMSWFName)) {
                        driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/div[4]/table/tbody/tr/td[1]")).click();
                        isRecordSelectedForWF = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelectedForWF) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.className("jtable-page-number-next")).click();//next page in New Document Details table
                    Thread.sleep(3000);
    ...
    public static boolean selMultiSelForCurricula(WebDriver driver, String multiCurriculaName, boolean isRecordSelectedForMultiCurrTble, int count) throws InterruptedException {
        ...
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"MultiCurriculaJTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
            String[] parts = a.split(" of ");
            totalNoOfRecords = Integer.parseInt(parts[1].trim());
        }
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((multiCurriculaName == null) || ("".equalsIgnoreCase(multiCurriculaName)))) {
                multiCurriculaName = driver.findElement(By.xpath(" //*[@id=\"MultiCurriculaJTable\"]/div/table/tbody/tr[1]/td[3]")).getText();
            } else if ((multiCurriculaName == null) || ("".equalsIgnoreCase(multiCurriculaName))) {
                multiCurriculaName = driver.findElement(By.xpath("//*[@id=\"MultiCurriculaJTable\"]/div/table/tbody/tr/td[3]")).getText();
            }
            count++;
        }
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String curriculaName = driver.findElement(By.xpath("//*[@id=\"MultiCurriculaJTable\"]/div/table/tbody/tr[" + i + "]/td[3]")).getText();
                        if (multiCurriculaName.equalsIgnoreCase(curriculaName)) {
                            driver.findElement(By.xpath("//*[@id=\"MultiCurriculaJTable\"]/div/table/tbody/tr[" + i + "]/td[3]")).click();
                    ...
                    String curriculaName = driver.findElement(By.xpath(" //*[@id=\"MultiCurriculaJTable\"]/div/table/tbody/tr/td[3]")).getText();
                    if (multiCurriculaName.equalsIgnoreCase(curriculaName)) {
                        driver.findElement(By.xpath(" //*[@id=\"MultiCurriculaJTable\"]/div/table/tbody/tr/td[3]")).click();
                        isRecordSelectedForMultiCurrTble = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelectedForMultiCurrTble) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#MultiCurriculaJTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next")).click();//next page in Curricula Details list
                    Thread.sleep(3000);
    ...
    public static boolean selectRecordForWorkFlowForSchedules(WebDriver driver, String workFlowName, boolean recSelectedForWF, int count) throws InterruptedException {
        WebElement table = driver.findElement(By.id("workFlowJtable"));
        WebElement tableBody = driver.findElement(By.tagName("tbody"));
        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
        int totalNoOfRecords = 0;
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((workFlowName == null) || ("".equalsIgnoreCase(workFlowName)))) {
                workFlowName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/table/tbody/tr[1]/td[1]")).getText();//WorkFlow Name

            } else if ((workFlowName == null) || ("".equalsIgnoreCase(workFlowName))) {
                workFlowName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/table/tbody/tr/td[1]")).getText();//WorkFlow Name
            }                                               
            ++count;
        }
        if (perPageNoOfRecordsPresent > 0) {
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String LMSWFName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/table/tbody/tr[" + i + "]/td[1]")).getText();//WorkFlow Name
                        if (workFlowName.equalsIgnoreCase(LMSWFName)) {
                            driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/table/tbody/tr[" + i + "]/td[1]")).click();
                    ...
                    String LMSWFName = driver.findElement(By.xpath("//*[@id=\"workFlowJtable\"]/div/table/tbody/tr/td[1]")).getText();
                    if (workFlowName.equalsIgnoreCase(LMSWFName)) {
...
//            String a = driver.findElement(By.className("jtable-page-info")).getText();// For Ex: Showing 1-1 of 1
        ...
        if (perPageNoOfRecordsPresent > 0) {
            while ((noOfRecordsChecked < totalNoOfRecords) && (!isRecordSelectedForSelectingMultiUsers)) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String selectingUser = driver.findElement(By.xpath("//*[@id=\"multiUserTableContainer\"]/div/table/tbody/tr[ " + i + " ]/td[1]/input")).getText();
                        if (multiUsersInSchedules.equalsIgnoreCase(selectingUser)) {
                            driver.findElement(By.xpath("//*[@id=\"multiUserTableContainer\"]/div/table/tbody/tr[ " + i + " ]/td[1]/input")).click();
                            isRecordSelectedForSelectingMultiUsers = true;
                            break;
                        }
                    ...
                    String selectingUser = driver.findElement(By.xpath("//*[@id=\"multiUserTableContainer\"]/div/table/tbody/tr/td[1]/input")).getText();
                    if (multiUsersInSchedules.equalsIgnoreCase(selectingUser)) {
                        driver.findElement(By.xpath("//*[@id=\"multiUserTableContainer\"]/div/table/tbody/tr/td[1]/input")).click();
                        isRecordSelectedForSelectingMultiUsers = true;
                        break;                           
                    }                                    
                }
                noOfRecordsChecked += perPageNoOfRecordsPresent;
                if ((!isRecordSelectedForSelectingMultiUsers) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.cssSelector("#multiUserTableContainer > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number.jtable-page-number-active.jtable-page-number-disabled")).click();//next page in single approval
                    Thread.sleep(3000);
