...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemPerform", "PSS-QMS-017", "Pass");
...
//	        WebElement element = driver.findElement(By.cssSelector("a[href='amActionItemPerformPage.do']"));
...
//	}
	...
	private void methodToDoAuditeeResponseApprove() throws Exception {
		...
		String AMId = properties.getProperty("ADHOC_NAME_WITH_AI_IN_ADHOC_SCHEDULE_AINO_REJECT_FLOW");
		...
		if (isRecordSelected) {
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Next Button", sno, false);
			Thread.sleep(3000);
			Select ApproveFrom = new Select(driver.findElement(By.id("appFromInAmPerform")));
			ApproveFrom.selectByVisibleText(properties.getProperty("AI_APPROVER"));
			Thread.sleep(2000);
			driver.findElement(By.id("commentsInAmPerform")).sendKeys(properties.getProperty("AM_1500"));
			Thread.sleep(2000);
			driver.findElement(
					By.xpath("//*[@id=\"attatchmentsJtableInAmActItemPerform\"]/div/div[3]/div[2]/span/span[2]"))
					.click();
			Thread.sleep(2000);
			driver.findElement(By.id("attachmentFileInAmActItem_1")).sendKeys(properties.getProperty("Document-1"));
			Thread.sleep(2000);
			sno++;
	...
	private boolean selectRecdAuditeeResponseApprove(String AMId, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			...
			WebElement element1 = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/div[4]/div[2]/span"));
            JavascriptExecutor js14 = (JavascriptExecutor)driver;
            js14.executeScript("arguments[0].scrollIntoView(true);", element1);
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((AMId == null) || ("".equalsIgnoreCase(AMId)))) {
				AMId = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr[1]/td[3]"))
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						WebElement element1 = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"));
			            JavascriptExecutor js14 = (JavascriptExecutor)driver;
			            js14.executeScript("arguments[0].scrollIntoView(true);", element1);
						String AMNumberSequence = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();// documentTypeName
						if (AMId.equalsIgnoreCase(AMNumberSequence)) {
							WebElement element2 = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"));
				            JavascriptExecutor js15 = (JavascriptExecutor)driver;
				            js15.executeScript("arguments[0].scrollIntoView(true);", element2);
					...
					WebElement element1 = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr/td[3]"));
		            JavascriptExecutor js14 = (JavascriptExecutor)driver;
		            js14.executeScript("arguments[0].scrollIntoView(true);", element1);
					String AMNumberSequence = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr/td[3]")).getText();
					if (AMId.equalsIgnoreCase(AMNumberSequence)) {
						WebElement element2 = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr/td[3]"));
			            JavascriptExecutor js15 = (JavascriptExecutor)driver;
			            js15.executeScript("arguments[0].scrollIntoView(true);", element2);
