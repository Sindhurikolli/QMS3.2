...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AuditeeResponseApproval"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);

			writer = PdfWriter.getInstance(document, fos);
		    writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("AuditeeResponse Approve", "PSS-QMS-001",
					"Pass");
...
//	}
    ...
    private void methodToDoAuditeeResponse() throws Exception {
        ...
        isRecordSelected = selectRecdAuditeeResponse(AMId, isRecordSelected, count);
        Thread.sleep(4000);
    ...
    private boolean selectRecdAuditeeResponse(String AMId, boolean isRecordSelected, int count) throws InterruptedException {
