 ...
 * @author likhitha
 */
public class QAReviewerAddendumApprove extends DeviationLoginDetails {
    
   @Test
    public void QAReviewerDeviation() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(10000);
        methodToDoQAReviewDeviation();
    }
      
    private void  methodToDoQAReviewDeviation() throws InterruptedException {
        int count = 0;
