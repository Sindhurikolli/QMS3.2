...
public class ActionItemPerform extends MCLoginDetails {
    ...
    public void ActionItemPerformMC() throws InterruptedException {
    	try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ActionItemPerformMC", "PSS-QMS-054",
					"Pass");
...
//    Thread.sleep(20000);
    ...
    wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.cssSelector("#actItmPerformTable > div > div.jtable-busy-message"))));
    ...
    private void methodToDoAIPerformMC() throws Exception {
        ...
        sno++;
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"supportingDocsAddTable_McActItem\"]/div/div[3]/div[2]/span/span[2]/b")).click();
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Add Supprting documents", sno,false);
        sno++;
        Thread.sleep(8000);
        driver.findElement(By.id("uploadSuppDocInMcActionItem_2")).sendKeys(properties.getProperty("Document-2"));
        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "upload the document", sno,false);
        sno++;
        Thread.sleep(5000);
        driver.findElement(By.id("commentsInMcPerform")).sendKeys(properties.getProperty("MC_2000"));
    ...
    private boolean selectRecdAIPerformMC(String MarketComplaintsId, boolean isRecordSelected, int count) throws InterruptedException {
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((MarketComplaintsId == null) || ("".equalsIgnoreCase(MarketComplaintsId)))) {
            	MarketComplaintsId = driver.findElement(By.xpath("//*[@id=\"actItmPerformTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
