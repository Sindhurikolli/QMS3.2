 ...
 * @author likhitha
 */
public class InvestigationMC extends MCLoginDetails {
	...
	public void InvestigationMC() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "InvestigationMC" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("InvestigationMC", "PSS-QMS-026", "Pass");
