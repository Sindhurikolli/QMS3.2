...
public class ExternalObservationAndResponseReview extends AMLoginDetails {

	@Test
	public void toExternalObservationAndResponseReview() throws Exception {
...
//		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("ExternalObservationsAndResponse Review",
					"PSS-QMS-009", "Pass");
...
//	}
	...
	private void methodToDoExternalAuditReview() throws Exception {
		...
		isRecordSelected = selectRecdmethodToDoExternalAuditReview(AuditId, isRecordSelected, count);
		Thread.sleep(1000);
		sno++;
	...
	private boolean selectRecdmethodToDoExternalAuditReview(String AuditId, boolean isRecordSelected, int count)
