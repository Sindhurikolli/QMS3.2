...
public class RegReviewerRoleBaseAccess extends DeviationLoginDetails{
...
//    }
    ...
    private void createRoleMethod() throws InterruptedException {
        Thread.sleep(1000);
         ...
         Roles.selectByVisibleText(properties.getProperty("Role_Name7"));;
         Thread.sleep(3000);
         driver.findElement(By.id("devRglReviewMenu")).click();
         Thread.sleep(3000); 
...
//         Thread.sleep(5000);
//         driver.findElement(By.id("devAddendumResponseMenu")).click();
//         Thread.sleep(3000); 
//         driver.findElement(By.id("devAddendumStatusMenu")).click();
//         Thread.sleep(3000); 
