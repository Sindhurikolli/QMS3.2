...
public class MultiUsersAssignRoleMarketComplaintsTest{

	static File resultFile = new File("QMS User Details for Automation.xlsx");
    public static DataFormatter formatter = new DataFormatter();

    @Test(dataProvider = "readExcelFile")
    public void toMultiUserCreation(String MarketComplaintsUserE_Code, String MarketComplaintsRoleName ) throws Throwable {
        Thread.sleep(1000);


		Thread.sleep(5000);
        PropertiesConfiguration properties = new PropertiesConfiguration("src\\test\\java\\QMSUIProperties\\QMS.properties");
		properties.setProperty("MarketComplaintsUserE_Code", MarketComplaintsUserE_Code);
		properties.setProperty("MarketComplaintsRoleName", MarketComplaintsRoleName);
		properties.save();
		
        Thread.sleep(5000);
        QMSLoginDetails login = new QMSLoginDetails();
        login.setUp();
        System.out.println("Role Assigned for - "+MarketComplaintsUserE_Code);
        MarketComplaintsAssignRole role = new MarketComplaintsAssignRole();
        role.MarketComplaintsAssignRoleMethod();
    ...
    public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
        ...
        XSSFSheet sh = wb.getSheet("MCRole");
