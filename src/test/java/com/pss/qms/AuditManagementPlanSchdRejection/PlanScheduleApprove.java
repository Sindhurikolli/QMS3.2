...
public class PlanScheduleApprove extends AMLoginDetails {

	@Test
	public void toPlanScheduleApprove() throws Exception {

//		try {
			document = new Document(PageSize.A4, 36, 36, 20, 20);
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "PlanScheduleApprove"
					+ (new Random().nextInt()) + ".pdf";
			fos = new FileOutputStream(output);
			writer = PdfWriter.getInstance(document, fos);
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("PlanScheduleApprove", "PSS-QMS-004", "Pass");
...
//	}
	...
	private void methodToDoAdhocApprove() throws Exception {
		...
		isRecordSelected = selectRecdAdhocApprove(AMId, isRecordSelected, count);
		Thread.sleep(1000);
		sno++;
	...
	private boolean selectRecdAdhocApprove(String AMId, boolean isRecordSelected, int count)
