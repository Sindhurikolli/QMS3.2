...
public class RegReviewerRole extends CCLoginDetails {
...
//	       String InvFirstName =properties.getProperty("First_Name1");
	       String UserFirstName =properties.getProperty("REG_ROLE_NAME");
...
//	       Thread.sleep(3000);
	       ...
	       Thread.sleep(3000);
	        driver.findElement(By.xpath("//*[@id=\"bootstrap-duallistbox-nonselected-list_\"]/option[22]")).click();
	         Thread.sleep(3000);
