 ...
 * @author likhitha
 */
public class DocumentReSubmitReject extends RegistrationLoginDetails  {
    ...
    public void ProductRegistration() throws InterruptedException {
        ...
        Thread.sleep(8000);
        driver.findElement(By.id("rejectSelectionInDocument")).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath("//*[@id=\"rejectedDocumentsGridId\"]/div/div[4]/table/tbody/tr/td[3]")).click();
        Thread.sleep(8000);
