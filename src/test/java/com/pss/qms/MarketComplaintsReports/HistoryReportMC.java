...
public class HistoryReportMC extends MCLoginDetails {
   ...
   @Test
    public void MCReports() throws InterruptedException {
        ...
        Thread.sleep(10000);
         driver.findElement(By.xpath("//*[@id=\"mcHistoryReportId\"]/a")).click();
        Thread.sleep(10000);
//        driver.findElement(By.id("invNumInInvRepForm")).sendKeys(properties.getProperty("MC_NUMBER2"));
//        Thread.sleep(3000);
//        driver.findElement(By.id("fromDate_McHistoryReportSearch")).sendKeys(properties.getProperty("FROM_DATE"));
//        Thread.sleep(4000);
//        driver.findElement(By.id("toDate_McHistoryReportSearch")).sendKeys(properties.getProperty("TO_DATE"));
//        Thread.sleep(3000);
...
//        Thread.sleep(5000);
//        driver.findElement(By.id("documentChk_McHistoryReportSearch")).click();
//        Thread.sleep(5000);
        driver.findElement(By.id("searchBtn_McHistoryReportPage")).click();
        Thread.sleep(5000);
        methodToDoMCReports();
    }
...
//        String changeCtrlSequence = properties.getProperty("CHG_CONTROL_NO");
        ...
        if (isRecordSelected) {
          String applicationWindowOrPDF = driver.getWindowHandle();
            ...
            WebElement element = driver.findElement(By.id("viewReportBtn_McHistoryReportPage"));
            jse.executeScript("arguments[0].scrollIntoView(true);", element);
            Thread.sleep(1000);
                 driver.findElement(By.id("viewReportBtn_McHistoryReportPage")).click();
                Thread.sleep(8000);
    ...
    private boolean selectRecdMCReports(String chgControlNumber, boolean isRecordSelected, int count) throws InterruptedException {
        WebElement table = driver.findElement(By.id("recordsTable_McHistoryReportPage"));
        WebElement tableBody = table.findElement(By.tagName("tbody"));
        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
        int totalNoOfRecords = 0;
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"recordsTable_McHistoryReportPage\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber)))) {
                chgControlNumber = driver.findElement(By.xpath(".//*[@id=\"recordsTable_McHistoryReportPage\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((chgControlNumber == null) || ("".equalsIgnoreCase(chgControlNumber))) {
                chgControlNumber = driver.findElement(By.xpath("//*[@id=\"recordsTable_McHistoryReportPage\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"recordsTable_McHistoryReportPage\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();//documentTypeName
                        if (chgControlNumber.equalsIgnoreCase(capaNumberSequence)) {
                            driver.findElement(By.xpath("//*[@id=\"recordsTable_McHistoryReportPage\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).click();
                    ...
                    String capaNumberSequence = driver.findElement(By.xpath("//*[@id=\"recordsTable_McHistoryReportPage\"]/div/table/tbody/tr[1]/td[3]")).getText();
                    if (chgControlNumber.equalsIgnoreCase(capaNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"recordsTable_McHistoryReportPage\"]/div/table/tbody/tr[1]/td[3]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.xpath(".//*[@id='recordsTable_McHistoryReportPage']/div/div[4]/div[1]/span[1]/span[4]")).click();//next page in Document approve list
                    Thread.sleep(3000);
                    table = driver.findElement(By.id("recordsTable_McHistoryReportPage"));//Document Tree approve table
