...
public class PostApprovalActionReInitate extends DeviationLoginDetails{
	 
	@Test
	    public void toPostApprovalActionReInitate() throws InterruptedException, IOException, DocumentException, Exception {
//			try {
...
//	        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Initiate Menu",sno,false);
	        Thread.sleep(4000);
	        sno++;
	        driver.findElement(By.id("rejectedPostAppActions_devPostAppActionsForm")).click();
	        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On reverted radio button",sno,false);
//	        Thread.sleep(6000);
//	         WebDriverWait wait1 = new WebDriverWait(driver, 440);
	        wait1.until(ExpectedConditions.invisibilityOf(driver.findElement(By.cssSelector("#rejPostAppActDevRecordsTable_devPostAppActionsForm > div > div.jtable-busy-message"))));
...
//	            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Select Button",sno,false);
	            sno++;
	            Thread.sleep(2000);
	            driver.findElement(By.id("reInitCommentsInAppActAddCapaWin")).sendKeys(properties.getProperty("Description_Of_Deviation"));
...
//	            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On Add Button",sno,false);
	...
	private boolean selectRecdPostApprovalActionsDeviationDeviation(String DeviationNumber, boolean isRecordSelected, int count) throws InterruptedException {
	        WebElement table = driver.findElement(By.id("rejPostAppActDevRecordsTable_devPostAppActionsForm"));
	        WebElement tableBody = table.findElement(By.tagName("tbody"));
	        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
	        int totalNoOfRecords = 0;
	        int noOfRecordsChecked = 0;
	        if (perPageNoOfRecordsPresent > 0) {
	            String a = driver.findElement(By.xpath("//*[@id=\"rejPostAppActDevRecordsTable_devPostAppActionsForm\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
	        ...
	        if (perPageNoOfRecordsPresent > 0 && count == 0) {
	            if ((totalNoOfRecords > 1) && ((DeviationNumber == null) || ("".equalsIgnoreCase(DeviationNumber)))) {
	                DeviationNumber = driver.findElement(By.xpath("//*[@id=\"rejPostAppActDevRecordsTable_devPostAppActionsForm\"]/div/table/tbody/tr[1]/td[16]")).getText();//documentType
	  ...
	  String DevNumberSequence = driver.findElement(By.xpath("//*[@id=\"rejPostAppActDevRecordsTable_devPostAppActionsForm\"]/div/table/tbody/tr[ " + i + " ]/td[16]")).getText();//documentTypeName
	                        if (DeviationNumber.equalsIgnoreCase(DevNumberSequence)) {
	                            driver.findElement(By.xpath("//*[@id=\"rejPostAppActDevRecordsTable_devPostAppActionsForm\"]/div/table/tbody/tr[ " + i + " ]/td[16]")).click();
	                    ...
	                    String DevNumberSequence = driver.findElement(By.xpath("//*[@id=\"rejPostAppActDevRecordsTable_devPostAppActionsForm\"]/div/table/tbody/tr[1]/td[16]")).getText();
	                    Thread.sleep(4000);
	                    if (DeviationNumber.equalsIgnoreCase(DevNumberSequence)) {
	                    	Thread.sleep(4000);
	                        driver.findElement(By.xpath("//*[@id=\"rejPostAppActDevRecordsTable_devPostAppActionsForm\"]/div/table/tbody/tr[1]/td[16]")).click();
	                        isRecordSelected = true;
	                        break;
	                    }
	                }
	                ...
	                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
	                    driver.findElement(By.cssSelector("#rejPostAppActDevRecordsTable_devPostAppActionsForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list")).click();//next page in Document approve list
	                    table = driver.findElement(By.id("rejPostAppActDevRecordsTable_devPostAppActionsForm"));//Document Tree approve table
