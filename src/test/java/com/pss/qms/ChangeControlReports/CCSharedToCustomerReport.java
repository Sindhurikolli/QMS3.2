 ...
 * @author likhitha
 */
public class CCSharedToCustomerReport extends CCLoginDetails {
    ...
    public void ChangeControlReports() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"ccCustomerSharedReportMenuId\"]/a")).click();
        Thread.sleep(10000);
...
//        Thread.sleep(5000);
        driver.findElement(By.id("searchBtnInCCSharedToCustForm")).click();
        Thread.sleep(8000);
...
//            Thread.sleep(1000);
              String applicationWindowOrPDF = driver.getWindowHandle();
                ...
                Thread.sleep(3000);
                driver.findElement(By.id("viewBtnInCcSharedCustReport")).click();
                Thread.sleep(12000);
...
//                
    ...
    private boolean selectRecdChangeControlDoctReports(String chgCtrlId, boolean isRecordSelected, int count) throws InterruptedException {
        WebElement table = driver.findElement(By.id("customerSharedCCDetailsTable"));
        WebElement tableBody = table.findElement(By.tagName("tbody"));
        int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
        int totalNoOfRecords = 0;
        int noOfRecordsChecked = 0;
        if (perPageNoOfRecordsPresent > 0) {
            String a = driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/div[4]/div[2]/span")).getText();// For Ex: Showing 1-1 of 1
        ...
        if (perPageNoOfRecordsPresent > 0 && count == 0) {
            if ((totalNoOfRecords > 1) && ((chgCtrlId == null) || ("".equalsIgnoreCase(chgCtrlId)))) {
            	chgCtrlId = driver.findElement(By.xpath(".//*[@id=\"customerSharedCCDetailsTable\"]/div/table/tbody/tr[1]/td[3]")).getText();//documentType
            } else if ((chgCtrlId == null) || ("".equalsIgnoreCase(chgCtrlId))) {
            	chgCtrlId = driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/table/tbody/tr/td[3]")).getText();//documentType
            ...
            while (noOfRecordsChecked < totalNoOfRecords) {
                if (totalNoOfRecords > 1) {
                    for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
                        String CCNumberSequence = driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).getText();
                        Thread.sleep(5000);
                        if (chgCtrlId.equalsIgnoreCase(CCNumberSequence)) {
                            Thread.sleep(5000);
                            driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).click();
                            Thread.sleep(5000);
                    ...
                    String CCNumberSequence = driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/table/tbody/tr/td[4]")).getText();
                    if (chgCtrlId.equalsIgnoreCase(CCNumberSequence)) {
                        driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/table/tbody/tr/td[4]")).click();
                        isRecordSelected = true;
                        break;
                    }
                }
                ...
                if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
                    driver.findElement(By.xpath("//*[@id=\"customerSharedCCDetailsTable\"]/div/div[4]/div[1]/span[1]/span[4]")).click();//next page in Document approve list
                    Thread.sleep(3000);
                    table = driver.findElement(By.id("customerSharedCCDetailsTable"));//Document Tree approve table
