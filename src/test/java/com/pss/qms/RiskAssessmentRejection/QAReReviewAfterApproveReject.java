...
public class QAReReviewAfterApproveReject extends RALoginDetails {

	@Test
	public void QAReReviewerRA() throws Exception {

		document = new Document(PageSize.A4, 36, 36, 20, 20);
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReReviewAfterApproveReject"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReReviewAfterApproveReject", "PSS-QMS-001", "Pass");
...
//         document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on MyActivities Tab",sno,false);  
		...
		methodToDoQAReReviewAfterApproveReject();
		Thread.sleep(3000);
		document.close();
		writer.close();
	...
	private void methodToDoQAReReviewAfterApproveReject() throws Exception {
