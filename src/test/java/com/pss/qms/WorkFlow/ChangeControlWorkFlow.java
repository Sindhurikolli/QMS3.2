...
public class ChangeControlWorkFlow extends QMSLoginDetails {

    @Test
    public void ChangeControlWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
        ...
        Thread.sleep(5000);
        toChangeControlWorkFlowMethod();
        
            }

    private void toChangeControlWorkFlowMethod() throws InterruptedException {
        Thread.sleep(1000);
     
        driver.findElement(By.id("selLocBtn_CCWorkflowUsersCreateForm")).click();
        Thread.sleep(3000);
        ...
        String DhodE_Codes = properties.getProperty("CCDepartmentHodE_Codes");
        ...
        Thread.sleep(3000);
        String QMSCoordinatorE_Codes = properties.getProperty("CCQMSCoordinatorE_Codes");
        ...
        jse.executeScript("window.scrollBy(0,250)");
        Thread.sleep(3000);
        String QAHODE_Codes = properties.getProperty("CCQAHODE_Codes");
        ...
        Thread.sleep(3000);
        String QualityHeadE_Codes = properties.getProperty("CCQualityHeadE_Codes");
