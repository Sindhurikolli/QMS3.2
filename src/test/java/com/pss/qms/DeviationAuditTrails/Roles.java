 ...
 * @author likhitha
 */
public class Roles extends DeviationLoginDetails {
...
//		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "Roles"
    ...
    Thread.sleep(10000);
    sno++;
    driver.findElement(By.xpath("//*[@id=\"devRolesATMenu_Id\"]/a")).click();
...
//    Thread.sleep(5000);
    sno++;
    driver.findElement(By.id("searchBtn_DevRolesATPage")).click();
