 ...
 * @author likhitha
 */
public class InstrumentRegistration extends RegistrationLoginDetails {
    ...
    public void ProductRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"regAddMenusListId\"]/ul/li[7]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath("//*[@id=\"TotalContent\"]/div[3]/ul/li[2]/a")).click();
        Thread.sleep(10000);
        driver.findElement(By.id("instmtNameInInstReg")).sendKeys(properties.getProperty("INSTRUMENT_NAME"));
        Thread.sleep(3000);
        driver.findElement(By.id("instmtIdInInstReg")).sendKeys(properties.getProperty("INSTRUMENT_ID"));
        Thread.sleep(4000);
        driver.findElement(By.id("instmtMakeInInstReg")).sendKeys(properties.getProperty("MAKE"));
        Thread.sleep(4000);
        Select Instrument_Type = new Select(driver.findElement(By.id("instypeInQmsReg")));
        Instrument_Type.selectByIndex(3);
        Thread.sleep(3000);
        Select Criticality = new Select(driver.findElement(By.id("criticalityIdInInstmtReg")));
        Criticality.selectByIndex(2);
        Thread.sleep(3000);
        driver.findElement(By.id("InsRegAppSelect")).click();
        Thread.sleep(4000);
...
//        Thread.sleep(1000);
         driver.findElement(By.id("areaRadioBtnInInstrument")).click();
        Thread.sleep(5000);
        driver.findElement(By.id("locSelBtnInCreateWF")).click();
        Thread.sleep(5000);
        driver.findElement(By.id("treeContainer_2_switch")).click();
        Thread.sleep(5000);
        driver.findElement(By.id("treeContainer_8_ico")).click();
        Thread.sleep(5000);
        driver.findElement(By.id("selectBtnInLocSelect")).click();
        Thread.sleep(5000);
        driver.findElement(By.id("InsRegSubBtnId")).click();
        Thread.sleep(5000);
