 ...
 * @author likhitha
 */
public class SpecificationRegistration extends RegistrationLoginDetails {
    ...
    public void SpecificationRegistration() throws InterruptedException {
        ...
        Thread.sleep(10000);
        driver.findElement(By.id("specNameInRegSpecification")).sendKeys(properties.getProperty("SPEC_NAME"));
        Thread.sleep(3000);
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath("//*[@id=\"ProSelRegSpecAddWinTable\"]/div/div[4]/table/tbody/tr[1]/td[2]")).click();
        Thread.sleep(4000);
